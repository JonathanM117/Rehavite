...
<head>
    ...
    <meta name="description"
        content="Ofrecemos servicios de fisioterapia en Durango. Estamos comprometidos en mejorar la salud de las personas al contar con tratamientos especializados de terapia física y rehabilitación. Servicios: Fisioterapia neurológica pediátrica, fisioterapia neurológica en adultos, fisioterapia ortopédica, masoterapia, etc.">
    <title>Inicio - Rehavite Fisioterapia Integral Para Una Vida Funcional</title>
    ...
    <meta property="og:image"
        content="https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fstorage.googleapis.com%2Fproduction-hostgator-mexico-v1-0-6%2F626%2F1598626%2FT0w2qiz2%2Fa8b58786c348426d8a2cc09c604d2e7c&methods=resize%2C1200%2C5000">
    ...
    <meta property="twitter:description"
        content="Ofrecemos servicios de fisioterapia en Durango. Estamos comprometidos en mejorar la salud de las personas al contar con tratamientos especializados de terapia física y rehabilitación. Servicios: Fisioterapia neurológica pediátrica, fisioterapia neurológica en adultos, fisioterapia ortopédica, masoterapia, etc.">
    <link prefetch="" prerender="/servicios">
    <link prefetch="" prerender="/nuestros-pacientes">
    <link prefetch="" prerender="/equipo">
    <link prefetch="" prerender="/sobre-nosotros">
    <link prefetch="" prerender="/contactanos">
    <link prefetch="" prerender="/ubicacion">
    <link prefetch="" prerender="/instalaciones">
    <link href="https://gfonts-proxy.wzdev.co/css?display=swap&amp;family=Fira+Sans:600,400,700|Cabin:400,700"
        rel="stylesheet">
    <style>
    :root {
        --kv-ee-heading-font-family: Fira Sans;
        --kv-ee-heading-font-weight: 600;
    ...
    *,
    ...
    .background-id_0 {
        --kv-ee-accent1-rgb: 70, 210, 184;
        --kv-ee-accent1: rgb(70, 210, 184);
        --kv-ee-accent1--h: 168;
        --kv-ee-accent1--s: 60%;
        --kv-ee-accent1--l: 54%;
        --kv-ee-accent1-background-rgb: 70, 210, 184;
        --kv-ee-accent1-background: rgb(70, 210, 184);
        --kv-ee-accent1-background--h: 168;
        --kv-ee-accent1-background--s: 60%;
        --kv-ee-accent1-background--l: 54%;
        --kv-ee-accent1-card-rgb: 70, 210, 184;
        --kv-ee-accent1-card: rgb(70, 210, 184);
        --kv-ee-accent1-card--h: 168;
        --kv-ee-accent1-card--s: 60%;
        --kv-ee-accent1-card--l: 54%;
        --kv-ee-accent2-rgb: 238, 157, 50;
        --kv-ee-accent2: rgb(238, 157, 50);
        --kv-ee-accent2--h: 34;
        --kv-ee-accent2--s: 84%;
        --kv-ee-accent2--l: 56%;
        --kv-ee-accent2-background-rgb: 238, 157, 50;
        --kv-ee-accent2-background: rgb(238, 157, 50);
        --kv-ee-accent2-background--h: 34;
        --kv-ee-accent2-background--s: 84%;
        --kv-ee-accent2-background--l: 56%;
        --kv-ee-accent2-card-rgb: 238, 157, 50;
        --kv-ee-accent2-card: rgb(238, 157, 50);
        --kv-ee-accent2-card--h: 34;
        --kv-ee-accent2-card--s: 84%;
        --kv-ee-accent2-card--l: 56%;
        ...
        --kv-ee-customtext3-rgb: 70, 210, 184;
        --kv-ee-customtext3: rgb(70, 210, 184);
        --kv-ee-customtext3--h: 168;
        --kv-ee-customtext3--s: 60%;
        --kv-ee-customtext3--l: 54%;
        --kv-ee-customtext4-rgb: 238, 157, 50;
        --kv-ee-customtext4: rgb(238, 157, 50);
        --kv-ee-customtext4--h: 34;
        --kv-ee-customtext4--s: 84%;
        --kv-ee-customtext4--l: 56%;
        ...
        --kv-ee-text2-card-rgb: 33, 33, 33;
        --kv-ee-text2-card: rgb(33, 33, 33);
        --kv-ee-text2-card--h: 0;
        --kv-ee-text2-card--s: 0%;
        --kv-ee-text2-card--l: 12%;
    ...
    .navigation-2 {
        z-index: 14;
        height: var(--navigation-height, 125px)
    }

    .navigation-2 .kv-ee-arrange-fixed {
        display: flex;
        align-items: stretch
    }

    @media(min-width:992px) {
        .navigation-2 .kv-ee-arrange-fixed .kv-ee-column {
            flex: 0 0 50%;
            position: relative
        }
    }

    .navigation-2 .drag-placeholder {
        background: #fff !important
    }

    .navigation-2 .kv-full-page .kv-ee-column {
        position: absolute
    }

    .navigation-2 .kv-ee-text-content {
        max-width: 640px;
        width: 100%;
        z-index: 1
    }

    .navigation-2 .kv-ee-section-subtitle {
        margin-top: -.5rem
    }

    .navigation-2 .kv-ee-section-description {
        max-width: 540px
    }

    .navigation-2 .kv-ee-align-right .kv-ee-section-description {
        margin-left: auto
    }

    .navigation-2 .kv-ee-align-center .kv-ee-section-description {
        margin-left: auto;
        margin-right: auto
    }

    .navigation-2 .kv-ee-header {
        width: 100%;
        height: 100%;
        order: 2
    }

    .navigation-2 .kv-ee-sub header {
        position: relative
    }
    ...
    .navigation-2 header>div {
        width: 100%;
        display: inline-block;
        padding: 1rem
    }

    .navigation-2 header .kv-ee-logo-image {
        max-width: 100%;
    ...
    .navigation-2 .kv-ee-sub .kv-ee-header>div.kv-ee-phone-button-container {
        position: absolute !important
    }

    .navigation-2 .kv-ee-sub .kv-ee-header .kv-ee-logo {
        color: var(--kv-ee-text1)
    }

    .navigation-2 .kv-ee-button-container {
        margin-top: 2rem;
        margin-left: -.5rem;
        margin-right: -.5rem
    }

    .navigation-2 .kv-ee-no-cover .kv-ee-header {
        background: var(--kv-ee-background);
        width: 100%;
        min-height: 5rem
    }
    ...
    @media(min-width:768px) {
        ...
        .navigation-2 .kv-ee-no-cover header .kv-ee-logo {
    ...
    .navigation-2 .kv-ee-no-cover header {
        position: relative;
        overflow: auto
    }

    .navigation-2 i.fa-close {
        opacity: 0
    }

    .navigation-2 .kv-ee-menu-open i.fa-bars {
        opacity: 0;
        transform: rotate(90deg)
    }

    .navigation-2 .kv-ee-menu-open i.fa-close {
        opacity: 1;
        transform: rotate(90deg)
    }

    .navigation-2 .kv-ee-menu-open .kv-menu {
        background-color: hsl(var(--kv-ee-accent1--h), var(--kv-ee-accent1--s), calc(var(--kv-ee-accent1--l) - 10%));
        position: fixed;
        right: 0;
        z-index: 12
    ...
    .navigation-2 .kv-ee-menu-open nav {
        position: fixed;
        overflow: scroll;
        top: 0;
        right: 0;
    ...
    .navigation-2 .kv-ee-menu-close i.fa-bars {
        opacity: 1
    }

    .navigation-2 .kv-ee-menu-close i.fa-close {
        opacity: 0
    }
    ...
    .navigation-2 nav>ul li {
        padding: 0 2rem;
        margin: .75rem 0
    }

    .navigation-2 nav>ul li a {
        color: var(--kv-ee-text1-accent1);
        text-shadow: none;
        display: inline-block;
        padding: .375rem 1rem;
    ...
    .navigation-2 nav>ul li a.kv-ee-active:after {
        content: '';
        width: .25rem;
        height: .25rem;
        border-radius: 50%;
        background-color: rgba(var(--kv-ee-text1-rgb), .2);
        display: block;
        position: absolute;
        left: 50%;
    ...
    .navigation-2 .kv-menu:hover {
        background-color: hsl(var(--kv-ee-accent1--h), var(--kv-ee-accent1--s), calc(var(--kv-ee-accent1--l) - 10%))
    }

    .navigation-2 .kv-menu i {
        position: absolute;
        text-decoration: none;
        font-size: 1.25rem;
        color: var(--kv-ee-text1-accent1);
    ...
    .navigation-2 .kv-ee-menu-open nav>ul {
        display: block;
        opacity: 1;
        transform: scale(1);
        transition: .5s .3s
    ...
    .navigation-2 .kv-ee-menu-close nav>ul {
        opacity: 0;
        transform: scale(0);
        transform-origin: top right
    }
    ...
    .navigation-2 .kv-ee-text-content h4 {
        line-height: 1.5
    }

    .navigation-2 hr.kv-ee-underline {
        border-color: rgba(var(--kv-ee-text1-rgb), .1);
        margin: 1rem 2rem
    }

    .navigation-2 .kv-ee-phone-button-mobile {
        display: block
    }
    ...
    @media(max-width:991px) {
        ...
        .navigation-2 .kv-ee-text-content {
            background-color: rgba(var(--kv-ee-background-rgb), .9);
            color: var(--kv-ee-text1-background);
            text-shadow: none;
        ...
        .navigation-2 .kv-ee-text-content.kv-ee-rounded-corners {
            border-radius: .75rem
        }
    }

    .navigation-2 .kv-ee-phone-button-container {
        display: none
    }

    .navigation-2 .kv-ee-phone-button-container a {
        text-decoration: none !important
    }

    .navigation-2 .kv-ee-phone-button-container a i {
        font-size: 1.25rem
    }
    ...
    @media(min-width:768px) {
        ...
        .navigation-2 .kv-ee-menu-open .kv-ee-phone-button-container {
            opacity: 0;
            transform: scale(.5)
        }
        ...
        .navigation-2 .kv-ee-phone-button-container .kv-ee-phone-button {
            line-height: 4rem;
            height: 4rem;
            border-radius: 0
        }

        .navigation-2 .kv-ee-phone-button-container .kv-ee-phone-button>div {
            width: 100%
        }
        ...
        .navigation-2 nav .kv-menu {
            padding: 2rem
        }

        .navigation-2 nav .kv-menu i {
            font-size: 1.5rem
        }

        .navigation-2 .kv-ee-fixed-navigation .kv-ee-phone-button-container {
            position: fixed
        }
    }
    ...
    @media(min-width:992px) {
        ...
        .navigation-2 header .kv-ee-logo {
            color: var(--kv-ee-text2);
            font-size: 2rem
        }

        .navigation-2 .kv-ee-content {
            height: 100%
        }
    ...
    .navigation-2 .kv-ee-subheader header {
        position: relative
    }

    .navigation-2 .kv-ee-subheader .kv-ee-logo {
        margin-top: 0;
        color: var(--kv-ee-text2-background);
        text-shadow: none
    }

    .navigation-2 .kv-ee-subheader .kv-menu {
        padding: 0;
        margin: auto
    }

    .navigation-2 .kv-ee-subheader nav {
        position: relative;
        width: 5rem;
        height: 5rem;
        display: flex;
    ...
    .navigation-2 .kv-ee-align-left {
        text-align: left
    }

    .navigation-2 .kv-ee-align-center {
        text-align: center
    }

    .navigation-2 .kv-ee-align-right {
        text-align: right
    }

    .navigation-2 .kv-ee-fixed-navigation nav {
        position: fixed
    }

    .navigation-2 .kv-ee-logo-group>div {
        float: left
    }

    .navigation-2 .kv-ee-logo-group>div,
    .navigation-2 .kv-ee-logo-group>img,
    .navigation-2 .kv-ee-logo-group>p,
    .navigation-2 .kv-ee-logo-group>span {
        margin: 0 12px
    }

    .navigation-2 .kv-ee-logo-group>div:first-child,
    .navigation-2 .kv-ee-logo-group>img:first-child,
    .navigation-2 .kv-ee-logo-group>p:first-child,
    .navigation-2 .kv-ee-logo-group>span:first-child {
        margin: 0
    }

    .navigation-2 .kv-ee-logo-group>div:last-child,
    .navigation-2 .kv-ee-logo-group>img:last-child,
    .navigation-2 .kv-ee-logo-group>p:last-child,
    .navigation-2 .kv-ee-logo-group>span:last-child {
        margin-right: 0
    }
    ...
    .navigation-2 .kv-ee-site-title-link {
        color: var(--kv-ee-text1);
        line-height: 2rem;
        padding: 1rem 0
    }

    .navigation-2 .kv-ee-no-cover .kv-ee-site-title-link {
        color: var(--kv-ee-text1)
    }

    .navigation-2 .kv-ee-logo-small .kv-ee-logo-image {
        max-height: 5rem
    }
    ...
    .navigation-2 .kv-ee-logo-medium .kv-ee-logo-image {
        max-height: 8rem
    }
    ...
    .navigation-2 .kv-ee-logo-large .kv-ee-logo-image {
        max-height: 10rem
    }
    ...
    .navigation-2 .kv-ee-logo-extra-large .kv-ee-logo-image {
        max-height: 14em
    }

    .navigation-2 .kv-ee-logo-group {
        position: relative;
        display: flex;
        justify-content: center;
        align-items: center;
    ...
    .navigation-2 .kv-scrolled .kv-ee-logo-group {
        position: fixed;
    ...
    .navigation-2 .kv-scrolled .kv-ee-logo-group .kv-ee-logo-image {
        max-height: 4rem
    }

    .navigation-2 .kv-scrolled .kv-ee-logo {
        display: flex;
        align-items: center;
        flex-direction: row !important;
        margin-left: 0
    ...
    .navigation-2 .kv-scrolled .kv-ee-logo .kv-ee-site-title-link {
        margin-left: 1rem;
        color: var(--kv-ee-text1-background);
        text-shadow: none;
        font-size: 1.5rem
    ...
    .navigation-2 .kv-ee-nav-title {
        margin-bottom: 0
    }

    .navigation-2 .kv-ee-nav-subtitle {
        color: rgba(var(--kv-ee-text1-rgb), .75);
        transition: color 160ms
    }

    .navigation-2 .kv-ee-nav-subtitle:hover {
        color: var(--kv-ee-text1-accent1);
        text-shadow: none
    }

    .navigation-2 .kv-ee-edit-mode {
        height: 125px;
        position: relative
    }
    ...
    .navigation-2 ul li a.kv-ee-active {
    ...
    .navigation-2 ul li ul:focus,
    .navigation-2 ul li ul:hover,
    .navigation-2 ul li:focus-within>ul,
    ...
    .navigation-2 li.kv-ee-with-children>a {
        pointer-events: none
    }

    .navigation-2 li.kv-ee-with-children:focus-within>a,
    .navigation-2 li.kv-ee-with-children:hover>a {
        pointer-events: all
    }

    .navigation-2 li:focus,
    .navigation-2 li:focus-within,
    .navigation-2 li:hover {
        cursor: pointer;
        text-decoration: underline
    }

    .navigation-2 li:focus-within a {
        outline: 0
    }

    .navigation-2 .kv-ee-with-children a:before {
        content: '';
        position: absolute;
        right: 0;
        top: 50%;
    ...
    .navigation-2 .kv-ee-menu-item-wrapper>.kv-ee-with-children a {
        padding-right: 1rem
    }

    .navigation-2 .kv-ee-menu-item-wrapper>.kv-ee-with-children li {
        text-align: center
    }

    .navigation-2 .kv-ee-menu-item-wrapper>.kv-ee-with-children>a:before {
        border-left: 4px solid transparent;
        border-right: 4px solid transparent;
        border-top: 5px solid var(--kv-ee-text1-accent1)
    }

    .navigation-2 .kv-ee-menu-item-wrapper>.kv-ee-with-children .kv-ee-with-children>a:before {
        left: 7px;
        right: auto;
        border-top: 4px solid transparent;
        border-bottom: 5px solid transparent;
        border-right: 4px solid var(--kv-ee-text1-accent1);
        border-left: 0
    }

    .navigation-2 .kv-ee-mobile .kv-ee-dropdown {
        padding-top: 0;
        right: 0
    }

    .navigation-2 .kv-ee-mobile .kv-ee-with-children .kv-ee-with-children>a:before {
        right: 0;
        left: auto;
    ...
    .yusaqi04 .kv-ee-intro {
        position: relative;
        width: 100%;
        box-sizing: border-box
    }

    .yusaqi04 .kv-ee-caption-underline {
        height: 1px;
        width: 15%;
    ...
    .yusaqi04 .kv-ee-description {
        max-width: 50rem;
        margin-bottom: 2rem
    }

    .yusaqi04 .kv-ee-align-left {
        text-align: left
    }

    .yusaqi04 .kv-ee-align-left .kv-ee-description {
        margin-right: auto
    }

    .yusaqi04 .kv-ee-align-center {
        text-align: center
    }

    .yusaqi04 .kv-ee-align-center .kv-ee-description {
        margin: 0 auto 2rem
    }

    .yusaqi04 .kv-ee-align-right {
        text-align: right
    }

    .yusaqi04 .kv-ee-align-right .kv-ee-description {
        margin-left: auto
    }
    ...
    .gadege31 .kv-ee-button {
        margin-top: .5rem;
        margin-bottom: .5rem
    }

    .gadege31 .kv-ee-align-left {
        text-align: left
    }

    .gadege31 .kv-ee-align-left .kv-ee-button {
        margin-right: .5rem
    }

    .gadege31 .kv-ee-align-center {
        text-align: center
    }

    .gadege31 .kv-ee-align-center .kv-ee-button {
        margin-left: .25rem;
        margin-right: .25rem
    }

    .gadege31 .kv-ee-align-right {
        text-align: right
    }

    .gadege31 .kv-ee-align-right .kv-ee-button {
        margin-left: .5rem
    }

    .gadege31 .kv-ee-rounded-corners .kv-ee-content-image {
        border-radius: .5rem
    }

    .gadege31 .kv-ee-drop-shadow .kv-ee-content-image {
        box-shadow: 0 .25rem 1rem rgba(0, 0, 0, .3)
    }

    .gadege31 .kv-ee-landscape .kv-ee-content-image {
        padding-bottom: 56.5%
    }

    .gadege31 .kv-ee-portrait .kv-ee-content-image {
        padding-bottom: 133%
    }

    .gadege31 .kv-ee-circle .kv-ee-content-image,
    .gadege31 .kv-ee-square .kv-ee-content-image {
        padding-bottom: 100%
    }
    ...
    .gadege31 .kv-ee-image-container {
        height: 100%
    }

    .gadege31 .kv-ee-blob,
    .gadege31 .kv-ee-circle,
    .gadege31 .kv-ee-landscape,
    .gadege31 .kv-ee-portrait,
    .gadege31 .kv-ee-square {
        height: unset
    }

    .gadege31 .kv-ee-filled {
        height: 100%;
        position: relative
    }

    @media(max-width:575px) {
        .gadege31 .kv-ee-filled .kv-ee-content-image {
            padding-bottom: 50%
        }

        .gadege31 .kv-ee-section-text {
    ...
    .gadege31 .kv-ee-effect-blur,
    .gadege31 .kv-ee-effect-grayscale,
    .gadege31 .kv-ee-effect-sepia,
    .gadege31 .kv-ee-effect-shine,
    .gadege31 .kv-ee-effect-zoom-in {
        height: 100%
    }

    .hagopy24 .kv-ee-section-title {
        color: var(--kv-ee-title1)
    }

    .hagopy24 .kv-ee-description {
        line-height: 1.75
    }

    .hagopy24 .kv-ee-overline {
        color: var(--kv-ee-text2);
        letter-spacing: .02em;
        margin-bottom: .25rem !important;
        margin-top: 0 !important
    ...
    .hagopy24 .kv-ee-align-left {
        text-align: left
    }

    .hagopy24 .kv-ee-align-center {
        text-align: center
    }

    .hagopy24 .kv-ee-align-center .kv-ee-section-description,
    .hagopy24 .kv-ee-align-center .kv-ee-section-subtitle,
    .hagopy24 .kv-ee-align-center .kv-ee-section-title {
        margin-left: auto;
        margin-right: auto
    }

    .hagopy24 .kv-ee-align-right {
        text-align: right
    }

    .hagopy24 .kv-ee-align-right .kv-ee-section-description,
    .hagopy24 .kv-ee-align-right .kv-ee-section-subtitle,
    .hagopy24 .kv-ee-align-right .kv-ee-section-title {
        margin-left: auto
    }

    .hagopy24 .kv-ee-button {
        margin-right: 1rem
    }
    ...
    <script type="application/javascript" src="/inicio.0bbe1d33.js"></script>
</head>

<body>
    <div>
        <div class="kv-site kv-main" tabindex="-1"> <a href="#ada-tab-anchor" class="skip-link"
                data-tag="ada-skip-link"></a>
            ...
            <content class="kv-page" name="page-home">
                <div class="kv-page-content ">
                    ...
                    <section class="background-id_0 section-5 navigation-2" style=" position:relative;"> <a
                            name="section5"></a>
                        ...
                        <div class="kv-background " style=" background-color: rgb(255,255,255);">
                            <div class="kv-background-inner " style=" background-color: rgb(255,255,255); "></div>
                        </div>
                        <div class="position-relative kv-content">
                            <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                            <div class="kv-ee-header kv-check-scroll kv-ee-fixed-navigation">
                                ...
                                <header>
                                    <div class="kv-ee-logo-group">
                                        <div data-type="logo" data-property="global.logo"
                                            class="kv-ee-logo-extra-large"> <img class="kv-ee-logo-image "
                                                style="background-position: center center;background-repeat: no-repeat;"
                                                data-setting="border"
                                                src="{{ asset('storage/imagenes/welcome/rehavitelogo.png') }}" <a
                                                href="/" data-href="/"
                                                style="width: 100%; height: 100%; display: block; position: absolute; top: 0; left: 0;"></a>
                                        </div> <a href="/" data-href="/" class=" kv-ee-site-title-link"> </a>
                                    </div>
                                </header>
                                <div class="kv-ee-phone-button-container"> <a
                                        class=" kv-ee-button-lg kv-ee-phone-button kv-ee-button-callToAction undefined kv-ee-button-dynamic-buttons kv-button-instant-edit kv-ee-button-primary "
                                        data-index="0" data-type="button" tabindex="0"
                                        data-href="https://wa.me/526181102286?text=¡Hola!%20Me%20gustaría%20más%20información%20para%20agendar%20una%20cita.%20Gracias.%20"
                                        href="https://wa.me/526181102286?text=¡Hola!%20Me%20gustaría%20más%20información%20para%20agendar%20una%20cita.%20Gracias.%20"
                                        target="_blank" data-property="global.callToAction"> <i class="fa fa-whatsapp">
                                        </i>
                                        <div style="" class="kv-ee-button-has-title">WhatsApp<div data-editable="button"
                                                data-prop="global.callToAction.title" style="display:none;"> </div>
                                        </div>
                                    </a> </div>
                                <nav> <a class="kv-menu"><i class="fa fa-bars"></i><i class="fa fa-close"></i></a>
                                    <ul class="kv-ee-menu-item-wrapper">
                                        <li class=""><a href="/" data-uri-path="/" target="_self"
                                                class="kv-ee-active kv-ee-nav-title kv-ee-body--lg">Inicio</a> </li>
                                        <li class=""><a href="#sobre-nosotros" data-uri-path="#sobre-nosotros"
                                                target="_self" class=" kv-ee-nav-title kv-ee-body--lg">Sobre
                                                nosotros</a> </li>
                                        <li class=""><a href="#equipo" data-uri-path="#equipo" target="_self"
                                                class=" kv-ee-nav-title kv-ee-body--lg">Equipo</a> </li>
                                        <li class=""><a href="#nuestros-pacientes" data-uri-path="#nuestros-pacientes"
                                                target="_self" class=" kv-ee-nav-title kv-ee-body--lg">Nuestros
                                                pacientes</a> </li>
                                        <li class=""><a href="#servicios" data-uri-path="#servicios" target="_self"
                                                class=" kv-ee-nav-title kv-ee-body--lg">Servicios</a> </li>
                                        <li class=""><a href="#instalaciones" data-uri-path="#instalaciones"
                                                target="_self" class=" kv-ee-nav-title kv-ee-body--lg">Instalaciones</a>
                                        </li>
                                        <li class=""><a href="#ubicacion" data-uri-path="#ubicacion" target="_self"
                                                class=" kv-ee-nav-title kv-ee-body--lg">Ubicación</a> </li>
                                        <li class=""><a href="#contactanos" data-uri-path="#contactanos" target="_self"
                                                class=" kv-ee-nav-title kv-ee-body--lg">Contáctanos</a> </li>
                                        <hr class="kv-ee-underline">
                                        <li>
                                            <div class="kv-ee-custom-header-buttons"><a
                                                    id="custom-header-button-template"
                                                    class="kv-ee-button-cart kv-ee-button-background kv-ee-button-primary"></a>
                                            </div>
                                        </li>
                                        <div class="kv-ee-phone-button-mobile">
                                            <li><a class=" kv-ee-button-lg kv-ee-phone-button kv-ee-button-callToAction undefined kv-ee-button-dynamic-buttons kv-button-instant-edit kv-ee-button-primary "
                                                    data-index="0" data-type="button" tabindex="0"
                                                    data-href="https://wa.me/526181102286?text=¡Hola!%20Me%20gustaría%20más%20información%20para%20agendar%20una%20cita.%20Gracias.%20"
                                                    href="https://wa.me/526181102286?text=¡Hola!%20Me%20gustaría%20más%20información%20para%20agendar%20una%20cita.%20Gracias.%20"
                                                    target="_blank" data-property="global.callToAction"> <i
                                                        class="fa fa-whatsapp"> </i>
                                                    <div style="" class="kv-ee-button-has-title">WhatsApp<div
                                                            data-editable="button" data-prop="global.callToAction.title"
                    ...
                    <section class="background-id_0m16 section-2 yusaqi04 kv-full-page" style=" position:relative;"> <a
                            name="section2"></a>
                        <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                        <div class="kv-background " style=" background-color: rgb(255,255,255);">
                            <div class="kv-background-inner "
                                data-image="background-image: url('https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fstorage.googleapis.com%2Fproduction-hostgator-mexico-v1-0-6%2F626%2F1598626%2FT0w2qiz2%2F5d3dbf3bece444608f5e2155d082eca1&amp;methods=resize%2C2000%2C5000');"
                                style=" background-image: url('https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fstorage.googleapis.com%2Fproduction-hostgator-mexico-v1-0-6%2F626%2F1598626%2FT0w2qiz2%2F5d3dbf3bece444608f5e2155d082eca1&amp;methods=resize%2C2000%2C5000'); background-color: rgb(255,255,255); opacity: 0.5;">
                            </div>
                        </div>
                        <div class="position-relative kv-content">
                            <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                            <div class="kv-ee-section kv-ee-section--sm kv-full-page">
                                <div class="kv-ee-intro">
                                    <div class="kv-ee-container">
                                        <div class="kv-ee-row">
                                            <div class="kv-ee-col-12 kv-ee-align-center">
                                                <h2 class="kv-ee-section-title kv-ee-section-title--md" data-type="text"
                                                    tabindex="0">
                                                    <font class="cstm-fnt" style="font-size: 100.01%;"><br>
                                                        <font class="cstm-fnt cstm-cl kv-ee-custom-text-cl2"
                                                            style="font-size: 140.086%;">En Rehavité buscamos la mejora
                                                            continua.
                                                        </font>
                                                    </font><br><span data-prop="title" class="ck-editable-element"
                                                        data-editable="basic" style="display:none;"></span>
                                                </h2>
                                                <hr class="kv-ee-caption-underline">
                                                <div class="kv-ee-section-text">
                                                    <p class="kv-ee-section-subtitle kv-ee-section-subtitle--sm"
                                                        data-type="text" tabindex="0">
                                                        <font class="cstm-fnt" style="font-size: 180.1%;">
                                                            <font class="cstm-fnt cstm-cl kv-ee-custom-text-cl2"
                                                                style="font-size: 94.4475%;"><b>
                                                                    <font class="cstm-fnt" style="font-size: 106.306%;">
                                                                        Te estamos esperando
                                                                    </font>
                                                                </b></font><br>
                                                        </font><span data-prop="subtitle" class="ck-editable-element"
                                                            data-editable="basic" style="display:none;"></span>
                                                    </p> <a
                                                        class=" kv-ee-button-lg kv-ee-m-2 undefined kv-ee-button-dynamic-buttons kv-button-instant-edit kv-ee-button-primary "
                                                        data-index="0" data-type="button" tabindex="0"
                                                        data-href="contactanos" href="#contactanos"
                                                        data-property="buttons" style="font-size: 125%">
                                                        <div style="font-size: 125%" class="kv-ee-button-has-title">
                                                            AGENDA TU CITA HOY<div data-editable="button"
                                                                data-prop="buttons.0.title" style="display:none;">
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                    ...
                    <section class="background-id_0 section-1683254634283 fenosa25" style=" position:relative;"> <a
                            name="section1683254634283"></a>
                        <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                        <div class="kv-background " style=" background-color: rgb(255,255,255);">
                            <div class="kv-background-inner " style=" background-color: rgb(255,255,255); "></div>
                        </div>
                        <div class="position-relative kv-content">
                            <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                            <div class="kv-ee-section kv-ee-section--sm kv-ee-align-left">
                                <div class="kv-ee-container">
                                    <div class="kv-ee-row">
                                        <div class="kv-ee-section-text kv-ee-col-lg-8 kv-ee-move">
                                            <div class="kv-ee-featured-image" data-type="icon" data-property="icon"> <i
                                                    class="fa fa-heart"> </i> </div>
                                            <h2 class="kv-ee-section-title kv-ee-section-title--md" data-type="text"
                                                tabindex="0">
                                                <font class="cstm-fnt cstm-cl kv-ee-custom-text-cl2"
                                                    style="font-size: 100.1%;">"Nos mueve la idea de ayudar a nuestros
                                                    pacientes a tener una mejor calidad de vida a través de nuestros
                                                    servicios de fisioterapia".</font><span data-prop="title"
                    ...
                    <section class="background-id_0adjacent section-3 gadege31 undefined" style=" position:relative;">
                        <a name="section3"></a>
                        <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                        <div class="kv-background " style=" background-color: rgb(249,249,249);">
                            <div class="kv-background-inner " style=" background-color: rgb(249,249,249); "></div>
                        </div>
                        <div class="position-relative kv-content">
                            <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                            <div class="kv-ee-section kv-ee-left kv-ee-section--sm kv-notify-inview">
                                <div class="kv-ee-container">
                                    <div class="kv-ee-row">
                                        <div class="kv-ee-col-sm-5">
                                            <div data-aspect-ratio="" class="kv-ee-image-container kv-ee-square">
                                                <div data-type="image" data-property="image"
                                                    class="kv-ee-content-image kv-ee-custom-border-cl3 loader"
                                                    role="img"
                                                    data-src="https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fstorage.googleapis.com%2Fproduction-hostgator-mexico-v1-0-6%2F626%2F1598626%2FT0w2qiz2%2F6c43620913dd49eb8c6b7d9da0ab8f63&amp;methods=resize%2C100%2C5000"
                                                    data-src-normal="https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fstorage.googleapis.com%2Fproduction-hostgator-mexico-v1-0-6%2F626%2F1598626%2FT0w2qiz2%2F6c43620913dd49eb8c6b7d9da0ab8f63&amp;methods=resize%2C1000%2C5000"
                                                    data-src-retina="https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fstorage.googleapis.com%2Fproduction-hostgator-mexico-v1-0-6%2F626%2F1598626%2FT0w2qiz2%2F6c43620913dd49eb8c6b7d9da0ab8f63&amp;methods=resize%2C1500%2C5000"
                                                    aria-label="woman walking on pathway during daytime"
                                                    alt="woman walking on pathway during daytime"
                                                    style=" border-style: solid; border-width: 5px; padding-bottom: calc(100% - 10px);background-position: center center;background-repeat: no-repeat;"
                                                    data-setting="border"></div>
                                            </div>
                                        </div>
                                        <div class="kv-ee-col-sm-7 kv-ee-margin-mobile">
                                            <div class="kv-ee-section-text kv-ee-align-left">
                                                <p class="kv-ee-section-description kv-ee-body--md" data-type="text"
                                                    tabindex="0">
                                                    <font class="cstm-fnt" style="font-size: 110.1%;">Estamos
                                                        comprometidos en mejorar la salud de las personas al contar con
                                                        tratamientos especializados que brindan bienestar físico,
                                                        mental, familiar y social,&nbsp;lo cual es fundamental para
                                                        alcanzar los mejores resultados en la recuperación de nuestros
                                                        pacientes.<br></font><span data-prop="description"
                                                        class="ck-editable-element" data-editable="basic"
                                                        style="display:none;"></span>
                                                </p>
                                            </div>
                    ...
                    <section class="background-id_0 section-1682566748811 hagopy24" style=" position:relative;"> <a
                            name="section1682566748811"></a>
                        <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                        <div class="kv-background " style=" background-color: rgb(255,255,255);">
                            <div class="kv-background-inner " style=" background-color: rgb(255,255,255); "></div>
                        </div>
                        <div class="position-relative kv-content">
                            <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                            <div class="kv-ee-section kv-ee-section--md">
                                <div class="kv-ee-container">
                                    <div class="kv-ee-row">
                                        <div
                                            class="kv-ee-col-lg-10 kv-ee-offset-lg-1 kv-ee-align-left kv-notify-inview kv-ee-section-text">
                                            <h2 class="kv-ee-section-title kv-ee-section-title--md" data-type="text"
                                                tabindex="0">
                                                <font class="cstm-cl kv-ee-custom-text-cl2">¿Por qué somos tu mejor
                                                    opción?</font><span data-prop="title" class="ck-editable-element"
                                                    data-editable="basic" style="display:none;"></span>
                                            </h2>
                                            <p class="kv-ee-description" data-type="text" tabindex="0">
                                                <font class="cstm-fnt cstm-cl kv-ee-custom-text-cl2"
                                                    style="font-size: 110.1%;">
                                                    <font class="cstm-fnt" style="font-size: 100%;">• Damos una atención
                                                        personalizada.<br>• Aplicamos tratamientos con equipos de
                                                        vanguardia y personal capacitado. <br>• Contamos con un sistema
                                                        de evaluación funcional para conocer el pronóstico y la
                                                        evolución de cada paciente. <br>• Realizamos tratamientos de
                                                        acuerdo con las necesidades de cada persona.<br>• Fomentamos el
                                                        trabajo interdisciplinario. <br>• Realizamos nuestro trabajo con
                                                        mucha dedicación y pasión para lograr mejores resultados. <br>•
                                                        Tenemos una excelente ubicación.&nbsp;<br>• Ten la certeza de
                                                        que recibes las sesiones adecuadas, invirtiendo solo lo que
                                                        necesitas.</font><br>
                                                </font><span data-prop="description" class="ck-editable-element"
                                                    data-editable="basic" style="display:none;"></span>
                                            </p> <a
                                                class=" kv-ee-button-md kv-ee-button kv-ee-mt-4 undefined kv-ee-button-dynamic-buttons kv-button-instant-edit kv-ee-button-primary "
                                                data-index="0" data-type="button" tabindex="0"
                                                data-href="sobre-nosotros" href="#sobre-nosotros"
                                                data-property="buttons">
                                                <div style="" class="kv-ee-button-has-title">Saber más<div
                                                        data-editable="button" data-prop="buttons.0.title"
                                                        style="display:none;"> </div>
                                                </div>
                                            </a>
                                        </div>
                    ...
                    <div id="sobre-nosotros">
                        <section class="background-id_2 section-1682546270176 hagopy24" style=" position:relative;"> <a
                                name="section1682546270176"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(70,210,184);">
                                <div class="kv-background-inner " style=" background-color: rgb(70,210,184); "></div>
                            </div>
                            <div class="position-relative kv-content">
                                <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                                    ...
                                    <div class="kv-ee-container">
                                        <div class="kv-ee-row">
                                            <div
                                                class="kv-ee-col-lg-10 kv-ee-offset-lg-1 kv-ee-align-left kv-notify-inview kv-ee-section-text">
                                                <h2 class="kv-ee-section-title kv-ee-section-title--md" data-type="text"
                                                    tabindex="0">Sobre nosotros<span data-prop="title"
                                                        class="ck-editable-element" data-editable="basic"
                                                        style="display:none;"></span></h2>
                                                <p class="kv-ee-description" data-type="text" tabindex="0">
                                                    <font class="cstm-fnt" style="font-size: 110.1%;">Creemos en el
                                                        potencial del ser humano y su capacidad para alcanzar metas
                                                        inimaginables. Influimos en nuestros pacientes para cumplir sus
                                                        objetivos de vida. Promovemos la funcionalidad y la libertad de
                                                        movimiento, lo que permite incrementar la independencia y
                                                        plenitud
                                                        de las personas, sean niños o adultos.</font><span
                        ...
                        <div class="kv-control-placeholder kv-_page" data-kv-control="2"> </div>
                        <section class="background-id_0 section-1682546507051 siteno05 siteli05 undefined"
                            style=" position:relative;"> <a name="section1682546507051"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(255,255,255);">
                                <div class="kv-background-inner " style=" background-color: rgb(255,255,255); "></div>
                            </div>
                            <div class="position-relative kv-content">
                                <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                                <div class="kv-ee-section kv-ee-align-left">
                                    <div class="kv-ee-container-fluid">
                                        <div class="kv-ee-row">
                                            <div class="kv-ee-col-12 kv-ee-seamless">
                                                <div class="kv-ee-content">
                                                    <div class="kv-control-placeholder kv-_content"
                                                        data-kv-control="list">
                                                    </div>
                                                    <div class="kv-ee-list-control">
                                                        <div class="kv-ee-row" data-type="list">
                                                            <div class="kv-control-placeholder kv-_list"
                                                                data-kv-control="0"> </div>
                                                            <div
                                                                class="kv-ee-col-12 kv-ee-col-sm-6 kv-ee-item kv-ee-section--lg">
                                                                <div class="kv-ee-content-text">
                                                                    <h2 class="kv-ee-title kv-ee-title--md"
                                                                        data-type="text" tabindex="0">Misión<span
                                                                            data-prop="title"
                                                                            class="ck-editable-element"
                                                                            data-editable="basic"
                                                                            style="display:none;"></span></h2>
                                                                    <p class="kv-ee-description" data-type="text"
                                                                        tabindex="0">
                                                                        <font class="cstm-fnt"
                                                                            style="font-size: 110.1%;">
                                                                            Nuestra misión es devolver la funcionalidad
                                                                            y la
                                                                            libertad de movimiento a nuestros pacientes,
                                                                            inspirando confianza y creando un espacio
                                                                            recreativo donde puedan desarrollar y
                                                                            mejorar
                                                                            sus capacidades físicas y mentales para
                                                                            construir su independencia.</font><span
                                                            ...
                                                            <div class="kv-control-placeholder kv-_list"
                                                                data-kv-control="1"> </div>
                                                            <div
                                                                class="kv-ee-col-12 kv-ee-col-sm-6 kv-ee-item kv-ee-section--lg">
                                                                <div class="kv-ee-content-text">
                                                                    <h2 class="kv-ee-title kv-ee-title--md"
                                                                        data-type="text" tabindex="0">Visión<span
                                                                            data-prop="title"
                                                                            class="ck-editable-element"
                                                                            data-editable="basic"
                                                                            style="display:none;"></span></h2>
                                                                    <p class="kv-ee-description" data-type="text"
                                                                        ...
                                                                        <font class="cstm-fnt"
                                                                            style="font-size: 110.1%;">
                                                                            Influir positivamente en la vida de miles de
                                                                            familias ayudando a descubrir el potencial
                                                                            de
                                                                            cada ser humano y aprovecharlo para
                                                                            contribuir a
                                                                            crear un mundo mejor.</font><span
                                                                            data-prop="description"
                                                                            class="ck-editable-element"
                                                                            data-editable="basic"
                                                                            style="display:none;"></span>
                    ...
                    <div id="equipo">
                        <section
                            class="background-id_0adjacent section-1682546507408 tehulu61 qunilo21 undefined undefined"
                            style=" position:relative;"> <a name="section1682546507408"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(249,249,249);">
                                <div class="kv-background-inner " style=" background-color: rgb(249,249,249); "></div>
                            </div>
                                    ...
                                    <div class="kv-ee-container kv-ee-titles">
                                        <div class="kv-ee-row">
                                            <div class="kv-ee-section-text kv-ee-col-12">
                                                <h2 class="kv-ee-section-title kv-ee-caption-title kv-ee-section-title--md"
                                                    data-type="text" tabindex="0">Conócenos<span data-prop="title"
                                                        class="ck-editable-element" data-editable="basic"
                                                        style="display:none;"></span></h2>
                                                <p class="kv-ee-section-description kv-ee-body--md" data-type="text"
                                                    tabindex="0">
                                                    <font class="cstm-fnt" style="font-size: 110.1%;">¡Juntos hacemos un
                                                        equipo increíble!</font><span data-prop="description"
                                                        class="ck-editable-element" data-editable="basic"
                                                        style="display:none;"></span>
                                                </p>
                                            ...
                                            <div class="kv-ee-col-12 kv-ee-circle">
                                                ...
                                                <div class="kv-ee-list-control">
                                                    <div class="kv-ee-row" data-type="list">
                                                        ...
                                                        <div class="kv-ee-col-12 kv-ee-content kv-ee-left ">
                                                            <div class="kv-ee-row">
                                                                <div class="kv-ee-col-sm-4">
                                                                    <div data-type="image" data-property="image"
                                                                        class="kv-ee-item-img kv-ee-gallery kv-ee-content-image "
                                                                        role="img"
                                                                        style="background-position: center center;background-position-x:62.47932907485018%;background-repeat: no-repeat;"
                                                                        data-setting="border">
                                                                        <img src="{{ asset('storage\imagenes\welcome\equipo1.JPEG') }}" alt="" style="width:100%; height:100%; border-radius:50%">
                                                                    </div>
                                                                </div>
                                                                <div class="kv-ee-col-sm-8 kv-ee-valign-center" style="padding-top:7.5%;">
                                                                    <div class="kv-ee-content-text">
                                                                        <h3 class="kv-ee-title--md" data-type="text"
                                                                            tabindex="0">Diana Delgado Medrano<span
                                                                                data-prop="title"
                                                                                class="ck-editable-element"
                                                                                data-editable="basic"
                                                                                style="display:none;"></span></h3>
                                                                        <p class="kv-ee-subtitle kv-ee-title--xs"
                                                                            data-type="text" tabindex="0">Lic. en
                                                                            Fisioterapia<br>Maestría en
                                                                            Neuro-rehabilitación<span
                                                                                data-prop="subtitle"
                                                                                class="ck-editable-element"
                                                                                data-editable="basic"
                                                                                style="display:none;"></span></p>
                                                                        <p class="kv-ee-body--md" data-type="text"
                                                                            tabindex="0">CÉD. PROF. 12666817<br><span
                                                                                data-prop="description"
                                                                                class="ck-editable-element"
                                                                                data-editable="basic"
                                                                                style="display:none;"></span></p>
                    ...
                    <div id="nuestros-pacientes">
                        <section class="background-id_0adjacent section-1682567300510 gajogu01 gudomu17 undefined"
                            style=" position:relative;"> <a name="section1682567300510"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(249,249,249);">
                                <div class="kv-background-inner " style=" background-color: rgb(249,249,249); "></div>
                            </div>
                            <div class="position-relative kv-content">
                                ...
                                <div class="kv-ee-section kv-ee-section--lg kv-ee-align-left ">
                                    <div class="kv-ee-container">
                                        <div class="kv-ee-row">
                                            <div class="kv-ee-section-text kv-ee-col-12 kv-ee-mb-3">
                                                <h2 class="kv-ee-section-title kv-ee-section-title--md" data-type="text"
                                                    tabindex="0">¿Qué dicen nuestros pacientes?<span data-prop="title"
                                                        class="ck-editable-element" data-editable="basic"
                                                        style="display:none;"></span></h2>
                                                <p class="kv-ee-section-subtitle kv-ee-section-subtitle--sm"
                                                    data-type="text" tabindex="0">
                                                    <font class="cstm-fnt" style="font-size: 110.1%;">Creemos que es
                                                        importante formar relaciones fuertes en un ambiente profesional
                                                        e
                                                        inspirar confianza para optimizar el proceso de rehabilitación
                                                        del
                                                        paciente en conjunto con sus seres queridos.</font><span
                                                        data-prop="subtitle" class="ck-editable-element"
                                                        data-editable="basic" style="display:none;"></span>
                                                </p>
                                                <p class="kv-ee-section-description kv-ee-body--md" data-type="text"
                                                    tabindex="0">
                                                    <font class="cstm-fnt" style="font-size: 110.1%;">Conoce algunos
                                                        testimonios de nuestros casos de éxito:</font><span
                                                        data-prop="description" class="ck-editable-element"
                                                        data-editable="basic" style="display:none;"></span>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="kv-ee-align">
                                            <div class="kv-control-placeholder kv-_content" data-kv-control="list">
                                            </div>
                                            <div class="kv-ee-list-control">
                                                <div class="kv-ee-row" data-type="list">
                                                    ...
                                                    <div
                                                        class="kv-ee-col-12 kv-ee-col-sm-6 kv-ee-stretch kv-notify-inview">
                                                        <div class="kv-ee-item">
                                                            <div class="kv-ee-item-content">
                                                                <div class="kv-ee-icon" data-type="icon"
                                                                    data-property="icon"> <i class="fa fa-quote-right" style="color: rgb(70,210,184);">
                                                                    </i>
                                                                </div>
                                                                <p class="kv-ee-description kv-ee-body--lg"
                                                                    data-type="text" tabindex="0">
                                                                    <font class="cstm-fnt" style="font-size: 110.1%;">
                                                                        &nbsp;Gracias por todo, Diana.<font
                                                                            class="cstm-fnt"
                                                                            style="font-size: 110.089%;">
                                                                            <font class="cstm-fnt"
                                                                                style="font-size: 90.8356%;">Estoy
                                                                                feliz,
                                                                            </font>
                                                                            <font class="cstm-fnt"
                                                                                style="font-size: 90.8356%;"> </font>sin
                                                                            duda
                                                                        </font>no habría estos avances sin tu dedicación
                                                                        y
                                                                        cariño para mi hija. ¡Gracias!</font><span
                                                                        data-prop="description"
                                                                        class="ck-editable-element"
                                                                        data-editable="basic"
                                                                        style="display:none;"></span>
                                                            ...
                                                            <div class="kv-ee-item-footer">
                                                                <div class="kv-ee-circle">
                                                                    <div class="kv-ee-image-container">
                                                                        <div data-type="image" data-property="image"
                                                                            class="kv-ee-item-image kv-ee-content-image "
                                                                            role="img"
                                                                            data-src="https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fimages.unsplash.com%2Fphoto-1537511446984-935f663eb1f4%3Fcrop%3Dentropy%26cs%3Dtinysrgb%26fit%3Dmax%26fm%3Djpg%26ixid%3DMnw1NTEzfDB8MXxzZWFyY2h8MjN8fG1hbnxlbnwwfHx8fDE2ODI4MjkzNzI%26ixlib%3Drb-4.0.3%26q%3D80%26w%3D60%26utm_source%3Dendurance-innovation%26utm_medium%3Dreferral"
                                                                            ...
                                                                            data-src-retina="https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fimages.unsplash.com%2Fphoto-1537511446984-935f663eb1f4%3Fcrop%3Dentropy%26cs%3Dtinysrgb%26fit%3Dmax%26fm%3Djpg%26ixid%3DMnw1NTEzfDB8MXxzZWFyY2h8MjN8fG1hbnxlbnwwfHx8fDE2ODI4MjkzNzI%26ixlib%3Drb-4.0.3%26q%3D80%26w%3D900%26utm_source%3Dendurance-innovation%26utm_medium%3Dreferral"
                                                                            aria-label="call" alt="call"
                                                                            style="background-position: center center;background-repeat: no-repeat;"
                                                                            data-setting="border"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="kv-ee-text-container">
                                                                    <p class="kv-ee-mb-0 kv-ee-body--md"
                                                                        data-type="text" tabindex="0">Alejandro R.<span
                                                                            data-prop="author"
                                                                            class="ck-editable-element"
                                                                            data-editable="basic"
                                                                            style="display:none;"></span></p>
                                                                    <p class="kv-ee-mb-0 kv-ee-lighten kv-ee-body--sm"
                                                                        data-type="text" tabindex="0">Papá de
                                                                        Angelline<span data-prop="authorTitle"
                                                                            class="ck-editable-element"
                                                                            data-editable="basic"
                                                                            style="display:none;"></span></p>
                                                                </div>
                                                        ...
                                                        <div class="kv-ee-item">
                                                            <div class="kv-ee-item-content">
                                                                ...
                                                                <p class="kv-ee-description kv-ee-body--lg"
                                                                    data-type="text" tabindex="0">
                                                                    <font class="cstm-fnt" style="font-size: 110.1%;">
                                                                        Creemos que eres una gran terapeuta y le has
                                                                        ayudado
                                                                        mucho a Jenny. Agradecemos mucho el tiempo que
                                                                        le
                                                                        has dedicado para que siga mejorando.</font>
                                                            ...
                                                            <div class="kv-ee-item-footer">
                                                                <div class="kv-ee-circle">
                                                                    <div class="kv-ee-image-container">
                                                                        <div data-type="image" data-property="image"
                                                                            class="kv-ee-item-image kv-ee-content-image "
                                                                            role="img"
                                                                            data-src="https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fimages.unsplash.com%2Fphoto-1581803118522-7b72a50f7e9f%3Fcrop%3Dentropy%26cs%3Dtinysrgb%26fit%3Dmax%26fm%3Djpg%26ixid%3DMnw1NTEzfDB8MXxzZWFyY2h8MTB8fG1hbnxlbnwwfHx8fDE2ODI4MjkzNzI%26ixlib%3Drb-4.0.3%26q%3D80%26w%3D60%26utm_source%3Dendurance-innovation%26utm_medium%3Dreferral"
                                                                            data-src-normal="https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fimages.unsplash.com%2Fphoto-1581803118522-7b72a50f7e9f%3Fcrop%3Dentropy%26cs%3Dtinysrgb%26fit%3Dmax%26fm%3Djpg%26ixid%3DMnw1NTEzfDB8MXxzZWFyY2h8MTB8fG1hbnxlbnwwfHx8fDE2ODI4MjkzNzI%26ixlib%3Drb-4.0.3%26q%3D80%26w%3D600%26utm_source%3Dendurance-innovation%26utm_medium%3Dreferral"
                                                                            data-src-retina="https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fimages.unsplash.com%2Fphoto-1581803118522-7b72a50f7e9f%3Fcrop%3Dentropy%26cs%3Dtinysrgb%26fit%3Dmax%26fm%3Djpg%26ixid%3DMnw1NTEzfDB8MXxzZWFyY2h8MTB8fG1hbnxlbnwwfHx8fDE2ODI4MjkzNzI%26ixlib%3Drb-4.0.3%26q%3D80%26w%3D900%26utm_source%3Dendurance-innovation%26utm_medium%3Dreferral"
                                                                            aria-label="PORTRAITS INSTAGRAM - @LGNWVRPRTRTS EDITORIAL INSTAGRAM - @LGNWVRPHTO PERSONAL INSTAGRAM - @LGNWVR"
                                                                            alt="PORTRAITS INSTAGRAM - @LGNWVRPRTRTS EDITORIAL INSTAGRAM - @LGNWVRPHTO PERSONAL INSTAGRAM - @LGNWVR"
                                                                            style="background-position: center center;background-repeat: no-repeat;"
                                                                            data-setting="border"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="kv-ee-text-container">
                                                                    <p class="kv-ee-mb-0 kv-ee-body--md"
                                                                        data-type="text" tabindex="0">Moisés S.<span
                                                                            data-prop="author"
                                                                            class="ck-editable-element"
                                                                            data-editable="basic"
                                                                            style="display:none;"></span></p>
                                                                    <p class="kv-ee-mb-0 kv-ee-lighten kv-ee-body--sm"
                                                                        data-type="text" tabindex="0">Papá de Jenny<span
                                                                            data-prop="authorTitle"
                                                                            class="ck-editable-element"
                                                                            data-editable="basic"
                                                                            style="display:none;"></span></p>
                                                                </div>
                    ...
                    <div id="servicios">
                        <section
                            class="background-id_0adjacent section-1682567152192 zoduye36 gadobe04 undefined undefined"
                            style=" position:relative;"> <a name="section1682567152192"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(249,249,249);">
                                <div class="kv-background-inner " style=" background-color: rgb(249,249,249); "></div>
                            </div>
                                ...
                                <div class="kv-ee-section kv-ee-section--lg kv-ee-align-left ">
                                    <div class="kv-ee-container kv-ee-titles">
                                        <div class="kv-ee-row">
                                            <div class="kv-ee-section-text kv-ee-col-12">
                                                <h2 class="kv-ee-section-title kv-ee-caption-title kv-ee-section-title--md"
                                                    data-type="text" tabindex="0">Servicios<span data-prop="title"
                                                        class="ck-editable-element" data-editable="basic"
                                                        style="display:none;"></span></h2>
                                                <p class="kv-ee-section-description kv-ee-body--md" data-type="text"
                                                    tabindex="0">
                                                    <font class="cstm-fnt" style="font-size: 110.1%;">En Rehavité,
                                                        nuestro
                                                        objetivo principal es ayudar a nuestros pacientes a recuperar su
                                                        movilidad, reducir el dolor, mejorar su calidad de vida y
                                                        aumentar
                                                        su independencia. Ofrecemos una amplia gama de servicios
                                                        personalizados para abordar las necesidades individuales de cada
                                                        paciente.<br></font><span data-prop="description"
                                                        class="ck-editable-element" data-editable="basic"
                                                        style="display:none;"></span>
                                                </p>
                                            </div>
                                    ...
                                    <div class="kv-ee-container kv-ee-items">
                                        <div class="row d-flex">
                                            ...
                                            <div class="col-md-6" style="width: 50%">
                                                <div class="card mx-2">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 30%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios1.JPEG') }}" alt="" style="width:100%; border-radius:50%">
                                                            </div>
                                                            <div style="width: 70%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text" style="height: 125px;">
                                                                    <b style="font-size: 150%">Estimulación temprana</b style="font-size: 100%"><br><br>
                                                                    Ayudamos a tu bebé a llegar a su máximo potencial.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6" style="width: 50%">
                                                <div class="card mx-2">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 30%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios2.JPEG') }}" alt="" style="width:100%; border-radius:50%">
                                                            </div>
                                                            <div style="width: 70%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text" style="height: 125px;">
                                                                    <b style="font-size: 150%">Intervención temprana</b style="font-size: 100%"><br><br>
                                                                    Somos especialistas en el manejo de pacientes que tuvieron complicaciones en su nacimiento.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6" style="width: 50%">
                                                <div class="card mx-2">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 30%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios3.JPEG') }}" alt="" style="width:100%; border-radius:50%">
                                                            </div>
                                                            <div style="width: 70%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text" style="height: 250px; overflow-y: auto;">
                                                                    <b style="font-size: 150%">Diagnóstico de parálisis cerebral en recién nacidos</b style="font-size: 100%"><br><br>
                                                                    Valoración de la integridad del sistema nervioso en el recién nacido con un método reconocido a nivel mundial y no invasivo.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6" style="width: 50%">
                                                <div class="card mx-2">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 30%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios4.JPEG') }}" alt="" style="width:100%; border-radius:50%">
                                                            </div>
                                                            <div style="width: 70%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text" style="height: 250px; overflow-y: auto;">
                                                                    <b style="font-size: 150% ">Diagnóstico y tratamiento del trastorno del desarrollo de la coordinación</b style="font-size: 100%"><br><br>
                                                                    Dirigido a niños de entre 4 a 16 años de edad que presentan dificultades del movimiento que se manifiestan con caídas frecuentes, dificultad o lentitud para escribir,  dificultad para abrochar sus agujetas o abotonar su ropa, temblor en manos al agarrar objetos pequeños, etc.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6" style="width: 50%">
                                                <div class="card mx-2">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 30%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios5.JPEG') }}" alt="" style="width:100%; border-radius:50%">
                                                            </div>
                                                            <div style="width: 70%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text" style="height: 250px; overflow-y: auto;">
                                                                    <b style="font-size: 150%">Fisioterapia neurológica pediátrica</b style="font-size: 100%"><br><br>
                                                                    Promueve la mayor independencia del paciente al establecer objetivos claros y alcanzables. Indicada para casos de parálisis cerebral, síndrome de Down, agenesia del cuerpo calloso, mielomeningocele, etc.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6" style="width: 50%">
                                                <div class="card mx-2">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 30%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios6.JPEG') }}" alt="" style="width:100%; border-radius:50%">
                                                            </div>
                                                            <div style="width: 70%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text" style="height: 250px; overflow-y: auto;">
                                                                    <b style="font-size: 150% ">Rehabilitación neurológica en adultos</b style="font-size: 100%"><br><br>
                                                                    Indicada para pacientes con daño neurológico como consecuencia de una enfermedad o lesión y que busquen recuperar su funcionalidad e independencia: lesión medular, EVC, enfermedad de Parkinson, Alzheimer, esclerosis múltiple, esclerosis lateral amiotrófica, traumatismo craneoencefálico, etc.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6" style="width: 50%">
                                                <div class="card mx-2">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 30%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios7.JPEG') }}" alt="" style="width:100%; border-radius:50%">
                                                            </div>
                                                            <div style="width: 70%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text" style="height: 250px; overflow-y: auto;">
                                                                    <b style="font-size: 150%">Rehabilitación ortopédica</b style="font-size: 100%"><br><br>
                                                                    Recomendada para aliviar el dolor, optimizar la recuperación y tener mayor libertad de movimiento en personas con lesiones ortopédicas: lumbalgia, dolor del nervio ciático, esguinces, fracturas, espasmos musculares, etc.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6" style="width: 50%">
                                                <div class="card mx-2">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 30%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios8.JPEG') }}" alt="" style="width:100%; border-radius:50%">
                                                            </div>
                                                            <div style="width: 70%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text" style="height: 250px; overflow-y: auto;">
                                                                    <b style="font-size: 150% ">Masoterapia</b style="font-size: 100%"><br><br>
                                                                    Ofrecemos una variedad de masajes de acuerdo a tus necesidades: masaje sueco (relajante), masaje descontracturante y masaje deportivo (descarga muscular).
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row d-flex">
                                            ...
                                            <div class="col-md-3" style="width: 50%"></div>

                                            <div class="col-md-6" style="width: 50% padding-left:25%">
                                                <div class="card mx-2">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 30%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios9.JPEG') }}" alt="" style="width:100%; border-radius:50%">
                                                            </div>
                                                            <div style="width: 70%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text" style="height: 250px; overflow-y: auto;">
                                                                    <b style="font-size: 150%">Terapia a domicilio</b style="font-size: 100%"><br><br>
                                                                    ¿No puedes acudir a nuestras instalaciones? ¡No te preocupes! Llevamos a nuestro personal hasta la puerta de tu casa con lo mejor de nuestros servicios y tratamientos.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="kv-control-placeholder kv-_page" data-kv-control="2"> </div>
                        <section class="background-id_0 section-1682566748993 zoduye36 vefova18 undefined undefined"
                            style=" position:relative;"> <a name="section1682566748993"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(255,255,255);">
                                <div class="kv-background-inner " style=" background-color: rgb(255,255,255); "></div>
                            </div>
                                ...
                                <div class="kv-ee-section kv-ee-section--lg kv-ee-align-left ">
                                    <div class="kv-ee-container kv-ee-titles">
                                        <div class="kv-ee-row">
                                            <div class="kv-ee-section-text kv-ee-col-12">
                                                <h2 class="kv-ee-section-title kv-ee-caption-title kv-ee-section-title--md"
                                                    data-type="text" tabindex="0">Tratamientos<span data-prop="title"
                                                        class="ck-editable-element" data-editable="basic"
                                                        style="display:none;"></span></h2>
                                                <p class="kv-ee-section-description kv-ee-body--md" data-type="text"
                                                    tabindex="0">
                                                    <font class="cstm-fnt" style="font-size: 110.1%;">Creemos que cada
                                                        persona es única, por ello, realizamos un abordaje integral para
                                                        asegurar la mejor calidad del tratamiento en base a los
                                                        objetivos y
                                                        necesidades personales. Nuestro equipo altamente capacitado de
                                                        fisioterapeutas utiliza técnicas innovadoras para ayudar a
                                                        nuestros
                                                        pacientes a alcanzar sus objetivos de salud y
                                                        bienestar.&nbsp;<br>
                                                    </font><span data-prop="description" class="ck-editable-element"
                                                        data-editable="basic" style="display:none;"></span>
                                                </p>
                                                    ...
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 40%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios10.JPEG') }}" alt="" style="width:100%; border-radius:5%">
                                                            </div>
                                                            <div style="width: 60%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text">
                                                                    <b style="font-size: 250%; text-align: end;">Mecanoterapia</b style="font-size: 100%"><br><br>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 60%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text">
                                                                    <b style="font-size: 250%">Ejercicio terapéutico</b style="font-size: 100%"><br><br>
                                                                </p>
                                                            </div>
                                                            <div style="width: 40%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios11.JPEG') }}" alt="" style="width:100%; border-radius:5%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-10" style="width: 90%">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 40%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios12.JPEG') }}" alt="" style="width:100%; border-radius:5%">
                                                            </div>
                                                            <div style="width: 60%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text">
                                                                    <b style="font-size: 250%; text-align: end;">Electroterapia</b style="font-size: 100%"><br><br>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 60%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text">
                                                                    <b style="font-size: 250%">Ultrasonido terapéutico</b style="font-size: 100%"><br><br>
                                                                </p>
                                                            </div>
                                                            <div style="width: 40%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios13.JPEG') }}" alt="" style="width:100%; border-radius:5%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-10" style="width: 90%">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 40%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios14.JPEG') }}" alt="" style="width:100%; border-radius:5%">
                                                            </div>
                                                            <div style="width: 60%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text">
                                                                    <b style="font-size: 250%; text-align: end;">Kinesiotaping</b style="font-size: 100%"><br><br>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 60%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text">
                                                                    <b style="font-size: 250%">Entrenamiento en suspensión</b style="font-size: 100%"><br><br>
                                                                </p>
                                                            </div>
                                                            <div style="width: 40%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios15.JPEG') }}" alt="" style="width:100%; border-radius:5%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-10" style="width: 90%">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 40%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios16.JPEG') }}" alt="" style="width:100%; border-radius:5%">
                                                            </div>
                                                            <div style="width: 60%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text">
                                                                    <b style="font-size: 250%; text-align: end;">Cupping</b style="font-size: 100%"><br><br>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 60%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text">
                                                                    <b style="font-size: 250%">Punción seca</b style="font-size: 100%"><br><br>
                                                                </p>
                                                            </div>
                                                            <div style="width: 40%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios17.JPEG') }}" alt="" style="width:100%; border-radius:5%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-10" style="width: 90%">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 40%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\servicios18.JPEG') }}" alt="" style="width:100%; border-radius:5%">
                                                            </div>
                                                            <div style="width: 60%; padding:5px; border-bottom: 2.5px solid rgb(70,210,184);">
                                                                <p class="card-text">
                                                                    <b style="font-size: 250%; text-align: end;">Massager gun</b style="font-size: 100%"><br><br>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div id="instalaciones">
                        <section class="background-id_0adjacent section-6 komupe08 yilugu00 undefined"
                            style=" position:relative;"> <a name="section6"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(249,249,249);">
                                <div class="kv-background-inner " style=" background-color: rgb(249,249,249); "></div>
                            </div>
                                ...
                                <div class="kv-ee-section kv-ee-section--lg kv-ee-align-left ">
                                    <div class="kv-ee-container">
                                        <div class="kv-ee-row">
                                            <div class="kv-ee-section-text kv-ee-col-12">
                                                <h2 class="kv-ee-section-title kv-ee-section-title--md" data-type="text"
                                                    tabindex="0">Conoce nuestras instalaciones<span data-prop="title"
                                                        class="ck-editable-element" data-editable="basic"
                                                        style="display:none;"></span></h2>
                                                <p class="kv-ee-section-description kv-ee-body--md" data-type="text"
                                                    tabindex="0">
                                                    <font class="cstm-fnt" style="font-size: 110.1%;">¡Estamos listos
                                                        para
                                                        compartir contigo una gran experiencia!</font><span
                                                        data-prop="description" class="ck-editable-element"
                                                        data-editable="basic" style="display:none;"></span>
                                                </p>
                                            </div>
                                        ...
                                        <div class="row d-flex">
                                            ...
                                            <div class="col-md-12" style="width: 100%">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 33.3%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion1.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                            <div style="width: 33.3%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion2.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                            <div style="width: 33.3%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion3.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12" style="width: 100%">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 33.3%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion4.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                            <div style="width: 33.3%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion5.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                            <div style="width: 33.3%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion6.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12" style="width: 100%">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 33.3%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion7.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                            <div style="width: 33.3%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion8.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                            <div style="width: 33.3%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion9.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div style=" display: flex; align-items: center; padding:2.5px">
                                                            <div style="width: 50%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion10.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                            <div style="width: 50%; padding:5px">
                                                                <img src="{{ asset('storage\imagenes\welcome\instalacion11.JPEG') }}" alt="" style="width:100%; border-radius:5%; filter: drop-shadow(7.5px 5px 1px rgba(0, 0, 0, 0.15));">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div id="ubicacion">
                        <section class="background-id_0adjacent section-8 kijubo11 undefined"
                            ...
                            <div class="position-relative kv-content">
                                <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                                <div>
                                    <div class="kv-ee-container kv-ee-align-left kv-ee-section--md">
                                        <div class="kv-ee-row">
                                            <div class=" kv-ee-col-md-12 kv-ee-mx-auto">
                                                <div class="kv-ee-container">
                                                    <div class="kv-ee-row">
                                                        <div class="kv-ee-col-12">
                                                            <div class="kv-ee-content-text kv-ee-section--sm ">
                                                                <div class="kv-ee-content-inner kv-ee-section-text">
                                                                    <hr class="kv-ee-line">
                                                                    <h2 class="kv-ee-section-title kv-ee-caption-title kv-ee-section-title--sm"
                                                                        data-type="text" tabindex="0">Siempre cerca de ti
                                                                        <span data-prop="title"
                                                                            class="ck-editable-element"
                                                                            data-editable="basic"
                                                                            style="display:none;"></span></h2>
                                                                    <p class="kv-ee-section-description kv-ee-body--md"
                                                                        data-type="text" tabindex="0">
                                                                        <font class="cstm-fnt"
                                                                            style="font-size: 110.1%;">
                                                                            Agrario 115, esq. con Pino Suárez, Col.
                                                                            Burócrata, C.P. 34279, Durango, Durango.
                                                                        </font>
                                                                        <span data-prop="description"
                                                                            class="ck-editable-element"
                                                                            data-editable="basic"
                                                                    ...
                                                                    <div class="kv-ee-buttons">
                                                                        <a class=" kv-ee-button-lg kv-ee-button undefined kv-ee-button-dynamic-buttons kv-button-instant-edit kv-ee-button-primary "
                                                                            data-index="0" data-type="button"
                                                                            tabindex="0"
                                                                            data-href="https://goo.gl/maps/Dro9REG2x7QF2dsL9?coh=178573&amp;entry=tt"
                                                                            href="https://goo.gl/maps/Dro9REG2x7QF2dsL9?coh=178573&amp;entry=tt"
                                                                            target="_blank" data-property="buttons"
                                                                            style="font-size: 112.5%">
                                                                            <div style="font-size: 112.5%"
                                                                                class="kv-ee-button-has-title">Abrir en
                                                                                Maps
                                            ...
                                            <div class="kv-ee-col-sm-6 align-self-center">
                                                <div data-aspect-ratio="" class=""> </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <section class="background-id_0 section-9 qinuwe98"
                                    style="position: relative; margin-top: 0px; margin-left: 12.5%; --decorator-offset: 0px; --next-decorator-offset: 0px; width:75% !important; height:100% !important;">

                                    <div class="position-relative kv-content"
                                        style="padding-top: 0px; padding-bottom: 0px; height:100% !important;">
                                        <div class="kv-ee-section kv-content" data-padding-top="0"
                                            style="margin-top: 0px;">
                                            <div class="kv-ee-container-fluid">
                                                <div class="kv-ee-row kv-ee-maps-container "><iframe
                                                        src="https://components.mywebsitebuilder.com/extern/maps-app/embed-place-express.html?q=agrario+115,+col.+burócrata,34279,Durango,+Dgo.,MX&amp;zoom=14&amp;mapType=roadmap&amp;center=none"
                                                        aria-label="Google Maps - agrario 115, col. burócrata,34279,Durango, Dgo.,MX"
                                                        title="Google Maps - agrario 115, col. burócrata,34279,Durango, Dgo.,MX"
                    ...
                    <div id="contactanos">
                        <section class="background-id_0adjacent section-1682830929138 fuqape11"
                            style=" position:relative;">
                            <a name="section1682830929138"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(249,249,249);">
                                <div class="kv-background-inner " style=" background-color: rgb(249,249,249); "></div>
                            </div>
                            <div class="position-relative kv-content">
                                <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                                <div class="kv-ee-container kv-ee-section--lg">
                                    <div class="kv-ee-row kv-ee-icon kv-ee-align-left">
                                        <div class="kv-ee-icon" data-type="icon" data-property="icon"> <i
                                                class="fa fa-clock-o"> </i> </div>
                                    </div>
                                    <div class="kv-ee-row kv-ee-align-left">
                                        <div class="kv-ee-col-md-8 kv-ee-content kv-ee-section-text">
                                            <h2 class="kv-ee-section-title kv-ee-title kv-ee-section-title--md"
                                                data-type="text" tabindex="0">Contáctanos<span data-prop="title"
                                                    class="ck-editable-element" data-editable="basic"
                                                    style="display:none;"></span></h2>
                                            <p class="kv-ee-section-description kv-ee-body--md" data-type="text"
                                                tabindex="0">
                                                <font class="cstm-fnt" style="font-size: 110.1%;">En Rehavité dar lo
                                                    mejor
                                                    de nosotros cada día es nuestra pasión, ¡y en tu salud está el
                                                    resultado!<br><br>Agenda tu cita, estaremos encantados de poder
                                                    ayudarte.</font><br><span data-prop="description"
                                                    class="ck-editable-element" data-editable="basic"
                                                    style="display:none;"></span>
                                            </p>
                                        </div>
                                    ...
                                    <div class="kv-ee-row">
                                        <div class="kv-ee-col-lg-4">
                                            <h3 class="kv-ee-title--sm" data-type="text" tabindex="0">Dirección<span
                                                    data-prop="addressTitle" class="ck-editable-element"
                                                    data-editable="basic" style="display:none;"></span></h3>
                                            <div class="kv-ee-row" data-type="address">
                                                <ul class="kv-ee-col-12 kv-ee-body-text">
                                                    <li class="kv-ee-body--md"> Agrario 115, Col. Burócrata<br> Durango,
                                                        Dgo., 34279 </li>
                                                </ul>
                                            </div>
                                            <h3 class="kv-ee-text-bold kv-ee-phone-title kv-ee-title--sm"
                                                data-type="text" tabindex="0">Teléfono / WhatsApp<span
                                                    data-prop="phoneTitle" class="ck-editable-element"
                                                    data-editable="basic" style="display:none;"></span></h3> <a
                                                class="kv-ee-phone-number kv-ee-body--md" href="tel:6181102286"
                                                data-type="phone">6181102286</a>
                                        </div>
                                        <div class="kv-ee-col-lg-8">
                                            <h3 class="kv-ee-title--sm" data-type="text" tabindex="0">Horario de
                                                atención<span data-prop="openingHoursTitle" class="ck-editable-element"
                                                    data-editable="basic" style="display:none;"></span></h3>
                                            <div class="kv-ee-row" data-type="openingHours">
                                                <ul class="kv-ee-col-md-12 kv-ee-opening-hours kv-ee-body-text">
                                                    <li><span class="kv-ee-day kv-ee-body--md">Lunes - Viernes</span>
                                                        <div class="kv-ee-hours-container"> <span
                                                                class="kv-ee-time kv-ee-body--md">10:00am –
                                                                08:00pm</span>
                                                        </div>
                                                    </li>
                                                    <li><span class="kv-ee-day kv-ee-body--md">Sábado </span>
                                                        <div class="kv-ee-hours-container"> <span
                                                                class="kv-ee-time kv-ee-body--md">10:00am –
                                                                02:00pm</span>
                                                        </div>
                                                    </li>
                                                    <li><span class="kv-ee-day kv-ee-body--md">Domingo </span>
                                                        <div class="kv-ee-hours-container"> <span
                                                                class="kv-ee-time kv-ee-body--md">Closed</span> </div>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="kv-control-placeholder kv-_page" data-kv-control="2"> </div>
                        <section class="background-id_0 section-1688253823227 xefako83 undefined"
                            style=" position:relative;"> <a name="section1688253823227"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(255,255,255);">
                                <div class="kv-background-inner " style=" background-color: rgb(255,255,255); "></div>
                            </div>
                            <div class="position-relative kv-content">
                                <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                                <div class="kv-ee-container kv-ee-section--lg">
                                    <div class="kv-ee-row" style="align-items: center;">
                                        <div class="kv-ee-col-12 kv-ee-col-md-6 kv-notify-inview kv-ee-from-right ">
                                            <div style="width: 100%;">
                                                <img src="{{ asset('storage\imagenes\welcome\contactanos1.JPG') }}" alt="" style="width:100%;">
                                            </div>
                                        </div>
                                        <div
                                            class="kv-ee-col-md-6 kv-ee-card-width kv-ee-col-12 kv-ee-mirrored kv-notify-inview kv-ee-from-left kv-ee-text-col">
                                            <div
                                                class="card kv-ee-text kv-ee-default-card kv-ee-section--lg kv-ee-section-text kv-ee-align-left"
                                                style="padding:50px; left: -150px; -webkit-box-shadow: 5px 7.5px 10px 0px rgba(0,0,0,0.75);
                                                    -moz-box-shadow: 5px 7.5px 10px 0px rgba(0,0,0,0.75);
                                                    box-shadow: 5px 7.5px 10px 0px rgba(0,0,0,0.75);">
                                                <h2 class="kv-ee-section-title kv-ee-on_card kv-ee-title--md"
                                                    data-type="text" tabindex="0">Programa tu cita<span
                                                        data-prop="title" class="ck-editable-element"
                                                        data-editable="basic" style="display:none;"></span></h2>
                                                <p class="kv-ee-section-subtitle kv-ee-on_card kv-ee-section-subtitle--sm"
                                                    data-type="text" tabindex="0">Accede a nuestro calendario y elige el
                                                    horario ideal para ti.<span data-prop="subtitle"
                                                        class="ck-editable-element" data-editable="basic"
                                                        style="display:none;"></span></p> <a
                                                    class=" kv-ee-button-card kv-ee-button kv-ee-button-md undefined kv-ee-button-dynamic-buttons kv-button-instant-edit kv-ee-button-primary "
                                                    data-index="0" data-type="button" tabindex="0"
                                                    data-href="https://calendar.app.google/jHuZDZJ8UbLWnYqV9"
                                                    href="https://calendar.app.google/jHuZDZJ8UbLWnYqV9" target="_blank"
                                                    data-property="buttons">
                                                    <div style="" class="kv-ee-button-has-title">AGENDA TU CITA HOY<div
                                                            data-editable="button" data-prop="buttons.0.title"
                                                            style="display:none;"> </div>
                                                    </div>
                                                </a>
                        ...
                        <div class="kv-control-placeholder kv-_page" data-kv-control="3"> </div>
                        <section class="background-id_2 section-12 qifefo36" style=" position:relative; background-color: white "> <a
                                name="section12"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(70,210,184);">
                                <div class="kv-background-inner " style=" background-color: rgb(70,210,184); "></div>
                            </div>
                            <div class=" position-relative kv-content" style="background-color: rgb(70,210,184)">
                                <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                                <div class="kv-ee-section kv-ee-section--sm kv-notify-inview kv-ee-align-left ">
                                    <div class="card kv-ee-container" style="padding:5% 15% 5% 15%">
                                        <div class="kv-ee-row">
                                            <div class="kv-ee-col-12">
                                                <div class="kv-ee-content-card kv-ee-shadow">
                                                    <div class="kv-ee-section-text kv-ee-head">
                                                        <h2 class="kv-ee-section-title kv-ee-on_card kv-ee-section-title--sm"
                                                            data-type="text" tabindex="0">Deja tu mensaje<span
                                                                data-prop="title" class="ck-editable-element"
                                                                data-editable="basic" style="display:none;"></span></h2>
                                                        <p class="kv-ee-section-description kv-ee-on_card kv-ee-body--md"
                                                            data-type="text" tabindex="0">
                                                            <font class="cstm-fnt" style="font-size: 110.1%;">Te
                                                                contactaremos a la brevedad.</font><span
                                                                data-prop="description" class="ck-editable-element"
                                                                data-editable="basic" style="display:none;"></span>
                                                        </p>
                                                        <hr class="kv-ee-underline">
                                                    ...
                                                    <form id="contact-form" data-type="contact">
                                                        ...
                                                        <div class="mb-12">
                                                            <label for="exampleInputPassword1" class="form-label">Correo</label><br>
                                                            <input type="email" class="form-control" id="fieldEmail" aria-describedby="emailHelp">
                                                        </div>
                                                        <div class="mb-12">
                                                            <label for="exampleInputPassword1" class="form-label">Telefono</label><br>
                                                            <input type="text" class="form-control" id="fieldPhone">
                                                        </div>
                                                        <div class="mb-12">
                                                            <label for="exampleInputPassword1" class="form-label">Asunto</label><br>
                                                            <input type="text" class="form-control" id="fieldSubject">
                                                        </div>
                                                        <div class="mb-12">
                                                            <label for="exampleInputPassword1" class="form-label">Mensaje</label><br>
                                                            <input type="text" class="form-control" id="fieldMessage">
                                                        </div>
                                                        <div class="mb-12 form-check">
                                                            <input type="checkbox" class="form-check-input" id="fieldSubscribe" value="false" >
                                                            <label class="form-check-label" for="exampleCheck1">
                                                                Al marcar esta casilla y enviar tu información, nos otorgas permiso para enviarte un mensaje o contactarte por teléfono. Puedes darte de baja en cualquier momento.
                                                            </label>
                                                        </div>
                                                        <div class="kv-ee-captcha-field-wrapper"></div> <button style=" background-color: rgb(70,210,184); "
                                                            class=" kv-ee-button kv-ee-button-md kv-ee-button-card kv-ee-mt-3 kv-ee-submit-button undefined kv-ee-button-dynamic-buttons kv-button-instant-edit undefined kv-ee-button-primary "
                                                            data-index="0" data-type="button" tabindex="0"
                                                            data-property="formData.submitButton">
                                                            <div>Enviar mensaje<div data-editable="button"
                                                                    data-prop="formData.submitButton.title"
                                                                    style="display:none;"></div>
                                                            </div>
                                                        </button>
                                                    </form>
                                                    <div class="kv-ee-contact-form-success">
                                                        <div class="kv-ee-success-close"> <i class="fa fa-close"></i>
                                                        </div>
                                                        <div class="kv-ee-success-message-wrapper">
                                                            <div class="kv-ee-section-icon kv-ee-on_card kv-ee-icon"
                                                                data-type="icon"> <i class="fa fa-check-circle"
                                                                    aria-hidden="true"></i> </div>
                                                            <h3>¡Mensaje enviado!</h3> Tu mensaje ha sido enviado con
                                                            éxito,
                                                            espera una respuesta en menos de 24 horas. También puedes
                                                            contactarnos a través de nuestras redes sociales. ¡Saludos!
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="kv-control-placeholder kv-_page" data-kv-control="4"> </div>
                        <section class="background-id_0 section-1682833173472 sobune02" style=" position:relative;"> <a
                                name="section1682833173472"></a>
                            <div class="kv-control-placeholder kv-_section" data-kv-control="background"> </div>
                            <div class="kv-background " style=" background-color: rgb(255,255,255);">
                                <div class="kv-background-inner " style=" background-color: rgb(255,255,255); "></div>
                            </div>
                            <div class="position-relative kv-content">
                                <div class="kv-control-placeholder kv-_section" data-kv-control="content"> </div>
                                <div
                                    class="kv-ee-container kv-ee-section--sm kv-ee-section kv-ee-align-left kv-ee-shape kv-ee-circle">
                                    <div class="kv-ee-row">
                                        <div class="kv-ee-section-text kv-ee-intro kv-ee-col-12">
                                            <h2 class="kv-ee-section-title kv-ee-title kv-ee-section-title--md"
                                                data-type="text" tabindex="0">Redes sociales<span data-prop="title"
                                                    class="ck-editable-element" data-editable="basic"
                                                    style="display:none;"></span></h2>
                                            <p class="kv-ee-section-description kv-ee-body--md" data-type="text"
                                                tabindex="0">
                                                <font class="cstm-fnt" style="font-size: 110.1%;">Encuéntranos en
                                                    nuestras
                                                    redes sociales.<br><br>
                                                    <font class="cstm-fnt" style="font-size: 90.8356%;">Facebook:&nbsp;
                                                        <font class="cstm-cl kv-ee-custom-text-cl2">
                                                            <b>rehavite.mx</b><br>Instagram:<b>
                                                                rehavite.mx</b><br>TikTok:<b>
                                                                rehavite.mx</b><br>Youtube:
                                                            <b>rehavitemx</b>
                                                        </font>
                                                    </font>
                                                </font><span data-prop="description" class="ck-editable-element"
                                        ...
                                        <div class="kv-ee-col-12">
                                            <div class="kv-ee-social">
                                                <div class="kv-ee-row">
                                                    <div class="kv-ee-col-12 kv-ee-align-content" data-type="social">
                                                        <div class="kv-notify-inview"><a
                                                                href="https://www.facebook.com/rehavite.mx"
                                                                target="_blank" class="kv-ee-social-link"
                                                                aria-label="Social link Facebook">
                                                                <i class="fa fa-facebook-official"></i> <span> Facebook
                                                                </span></a></div>
                                                        <div class="kv-notify-inview"><a
                                                                href="https://www.instagram.com/rehavite.mx/"
                                                                target="_blank" class="kv-ee-social-link"
                                                                aria-label="Social link Instagram"> <i
                                                                    class="fa fa-instagram"></i> <span> Instagram
                                                                </span></a></div>
                                                        <div class="kv-notify-inview"><a
                                                                href="https://www.youtube.com/@rehavitemx"
                                                                target="_blank" class="kv-ee-social-link"
                                                                aria-label="Social link YouTube">
                                                                <i class="fa fa-youtube-play"></i> <span> YouTube
                                                                </span></a></div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="footerDiv">
                        <section class="background-id_0adjacent section-1 bajigu69" style="position: relative; margin-top: 0px; --decorator-offset: 0px; --next-decorator-offset: 0px;">
                            <a name="section1"></a>
                            <div class="kv-background  " style=" background-color: rgb(249,249,249);">
                            <div class="kv-background-inner " style="background-color: rgb(249,249,249);"></div>
                            </div>
                            <div class="position-relative kv-content" style="padding-top: 0px;">
                            <footer class="kv-content" data-padding-top="0" style="margin-top: 0px;">
                                <div class="kv-ee-container kv-ee-spacing">
                                    <div class="kv-ee-row kv-ee-align-center">
                                        <div class="kv-ee-top-footer">
                                            <nav>
                                                <ul>
                                                    <li class=""><a href="/" data-uri-path="/" target="_self"
                                                            class="kv-ee-active kv-ee-opaque kv-ee-body-text">Inicio</a>
                                                    </li>
                                                    <li class=""><a href="#sobre-nosotros" data-uri-path="#sobre-nosotros"
                                                            target="_self" class=" kv-ee-opaque kv-ee-body-text">Sobre
                                                            nosotros</a>
                                                    </li>
                                                    <li class=""><a href="#equipo" data-uri-path="#equipo" target="_self"
                                                            class=" kv-ee-opaque kv-ee-body-text">Equipo</a> </li>
                                                    <li class=""><a href="#nuestros-pacientes"
                                                            data-uri-path="#nuestros-pacientes" target="_self"
                                                            class=" kv-ee-opaque kv-ee-body-text">Nuestros pacientes</a>
                                                    </li>
                                                    <li class=""><a href="#servicios" data-uri-path="#servicios"
                                                            target="_self"
                                                            class=" kv-ee-opaque kv-ee-body-text">Servicios</a> </li>
                                                    <li class=""><a href="#instalaciones" data-uri-path="#instalaciones"
                                                            target="_self"
                                                            class=" kv-ee-opaque kv-ee-body-text">Instalaciones</a>
                                                    </li>
                                                    <li class=""><a href="#ubicacion" data-uri-path="#ubicacion"
                                                            target="_self"
                                                            class=" kv-ee-opaque kv-ee-body-text">Ubicación</a> </li>
                                                    <li class=""><a href="#contactanos" data-uri-path="#contactanos"
                                                            target="_self"
                                                            class=" kv-ee-opaque kv-ee-body-text">Contáctanos</a> </li>
                                                </ul>
                                            </nav>
                                            <div class="kv-ee-logo-group">
                                                <div data-type="logo" data-property="global.logo"
                                                    class="kv-ee-logo-extra-large"> <img class="kv-ee-logo-image loader"
                                                        style="background-position: center center;background-repeat: no-repeat;"
                                                        data-setting="border"
                                                        src="https://images.builderservices.io/s/cdn/v1.0/i/m?url=https%3A%2F%2Fstorage.googleapis.com%2Fproduction-hostgator-mexico-v1-0-6%2F626%2F1598626%2FT0w2qiz2%2Fc69567d553fc49158190185954c1ee4a&amp;methods=resize%2C1000%2C5000">
                                                    <a href="/" data-href="/"
                                                        style="width: 100%; height: 100%; display: block; position: absolute; top: 0; left: 0;"></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="kv-ee-row ">
                                        <div class="kv-ee-item-25">
                                            <h4 class="kv-ee-title" data-type="text" tabindex="0">UBICACIÓN<span
                                                    data-prop="titleAddress" class="ck-editable-element"
                                                    data-editable="basic" style="display:none;"></span></h4>
                                            <p class="kv-ee-opaque" data-type="address">Agrario 115, Col. Burócrata<br>
                                                Durango, Dgo., 34279, MX</p>
                                            <div class="kv-ee-buttons"> <a href="tel:6181102286" data-type="phone"
                                                    class="kv-ee-body--sm">6181102286</a> <a href="mailto:hola@rehavite.com"
                                                    data-type="email" class="kv-ee-body--sm">hola@rehavite.com</a> </div>
                                        </div>
                                        <div class="kv-ee-item-50">
                                            <h4 class="kv-ee-title" data-type="text" tabindex="0">Rehavité |
                                                Fisioterapia integral para una vida funcional<span
                                                    data-prop="titleDescription" class="ck-editable-element"
                                                    data-editable="basic" style="display:none;"></span></h4>
                                            <p class="kv-ee-opaque" data-type="text" tabindex="0">Ven con nosotros y te
                                                sentirás mejor<span data-prop="description" class="ck-editable-element"
                                ...
                                <div class="kv-ee-subfooter">
                                    <div class="kv-ee-container-fluid">
                                        <div class="kv-ee-row">
                                            <div class="kv-ee-content-left kv-ee-legal">
                                                <p><span data-type="copyright">© 2023 Rehavité | Fisioterapia integral
                                                        para una vida funcional</span></p>
                                                <div class="kv-ee-legal-placeholder"></div>
                                            </div>
                                            <div class="kv-ee-content-right">
                                                <p class="kv-ee-opaque kv-ee-title-social" data-type="text" tabindex="0">
                                                    SÍGUENOS<span data-prop="titleSocial" class="ck-editable-element"
                                                        data-editable="basic" style="display:none;"></span></p>
                                                <div class="kv-ee-social-icons" data-type="social"> <a
                                                        href="https://www.facebook.com/rehavite.mx" target="_blank"
                                                        class="kv-ee-social-link" aria-label="Social link Facebook"> <i
                                                            class="fa fa-facebook-official"></i> </a> <a
                                                        href="https://www.instagram.com/rehavite.mx/" target="_blank"
                                                        class="kv-ee-social-link" aria-label="Social link Instagram"> <i
                                                            class="fa fa-instagram"></i> </a> <a
                                                        href="https://www.youtube.com/@rehavitemx" target="_blank"
                                                        class="kv-ee-social-link" aria-label="Social link YouTube"> <i
    ...
    <script src="https://runtime.builderservices.io/runtime-endurance-21754/bundle.js"></script>
    ...
    window._site = {
        "globalSections": {
            "footer": {
                ...
                "binding": {
                    ...
                    "description": "Ven con nosotros y te sentirás mejor",
                    "title": "Click here to edit your title",
                    "titleNavigation": "Pages",
                    "titleSocial": "SÍGUENOS",
                    "titleAddress": "UBICACIÓN",
                    "titleDescription": "Rehavité | Fisioterapia integral para una vida funcional",
                    "copyright": true,
                    "pagesMenu": true,
                    "fullPage": false,
                    "_placeholders": {
        ...
        "globalBinding": {
            "accounts": {
                "facebook": "https://www.facebook.com/rehavite.mx",
                "instagram": "https://www.instagram.com/rehavite.mx/",
                "youtube": "https://www.youtube.com/@rehavitemx"
            },
            "translations": {
                "ada": {
            ...
            "menuData": [],
            "logo": {
                "value": "https://storage.googleapis.com/production-hostgator-mexico-v1-0-6/626/1598626/T0w2qiz2/c69567d553fc49158190185954c1ee4a",
                "logoSizeClass": "kv-ee-logo-extra-large"
            },
            "title": "Fisioterapia",
            "callToAction": {
                "source": "global.phone",
            ...
            "legal": {
                "privacyPolicy": {
                    ...
                    "bannerText": "Este sitio usa cookies",
                    "agreeButtonText": "Estoy de acuerdo",
                    "privacyPolicyText": ""
                },
                "termsOfService": {
                    "termsOfServiceText": ""
            ...
            "address": {
                "street": "Agrario 115, Col. Burócrata",
                "zip": "34279",
                "city": "Durango, Dgo.",
                "country": "MX"
            },
            "companyName": "Rehavité | Fisioterapia integral para una vida funcional",
            "phone": "6181102286",
            "email": "hola@rehavite.com"
        },
        "theme": {
            "colors": {
            ...
            "hasAlternatingBackgrounds": true
        },
        "pages": [{
            "id": "home",
            "title": "Inicio",
            "sections": [{
                ...
                "binding": {
                    ...
                    "image": {
                        "value": "https://storage.googleapis.com/production-hostgator-mexico-v1-0-6/626/1598626/T0w2qiz2/d16bc1226a664b439aa30c069aed8e76",
                        "altText": "assorted fruits and vegetables on green surface",
                        "imageColor": "#408c59",
                        "originalSize": {
                            "width": 5836,
                            "height": 3284
                    ...
                    "title": "<font class=\"cstm-fnt\" style=\"font-size: 100.01%;\"><br><font class=\"cstm-fnt cstm-cl kv-ee-custom-text-cl2\" style=\"font-size: 140.086%;\">En Rehavité buscamos la mejora continua.</font></font><br>",
                    "subtitle": "<font class=\"cstm-fnt\" style=\"font-size: 180.1%;\"><font class=\"cstm-fnt cstm-cl kv-ee-custom-text-cl2\" style=\"font-size: 94.4475%;\"><b><font class=\"cstm-fnt\" style=\"font-size: 106.306%;\">Te estamos esperand</font><font class=\"cstm-fnt\" style=\"font-size: 106.306%;\">o</font></b></font><br></font>",
                    "fullPage": true,
                    "_placeholders": {
                    ...
                    "background": {
                        ...
                        "img": {
                            "source": "uploads",
                            "noCdn": false,
                            "value": "https://storage.googleapis.com/production-hostgator-mexico-v1-0-6/626/1598626/T0w2qiz2/5d3dbf3bece444608f5e2155d082eca1",
                            "contrastColor": 0
                        },
                        "opacity": 50,
                        "sectionHeight": 587,
                        ...
                        "prevShouldRenderDivider": false
                    },
                    "contentAlignment": "kv-ee-align-center",
                    "divider": true
                }
            }, {
                "id": 1683254634283,
                ...
                "binding": {
                    ...
                    "image": {
                        "value": "https://images.unsplash.com/photo-1674574124792-3be232f1957f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=Mnw1NTEzfDF8MXxzZWFyY2h8OHx8SGVhbHRofGVufDB8fHx8MTY4MzIyNTkwMA&ixlib=rb-4.0.3&q=80&w=1080"
                    },
                    "description": "Utiliza esta sección de detalles para explicar lo que quieres que los visitantes hagan. Por ejemplo: hacer clic en un enlace, comprar en la tienda virtual, ir a la tienda física, o pedir una cita.",
                    "title": "<font class=\"cstm-fnt cstm-cl kv-ee-custom-text-cl2\" style=\"font-size: 100.1%;\">\"Nos mueve la idea de ayudar a nuestros pacientes a tener una mejor calidad de vida a través de nuestros servicios de fisioterapia\".</font>",
                    "subtitle": "¡Echa un vistazo a nuestras últimas ofertas especiales!",
                    "_placeholders": {
                        "subtitle": "¡Echa un vistazo a nuestras últimas ofertas especiales!",
                        "description": "Utiliza esta sección de detalles para explicar lo que quieres que los visitantes hagan. Por ejemplo: hacer clic en un enlace, comprar en la tienda virtual, ir a la tienda física, o pedir una cita."
                    },
                    ...
                    "contentAlignment": "kv-ee-align-left",
                    "sectionSize": "kv-ee-section--sm",
                    "background": {
                        "colorIndex": 0,
                        "divider": {
                ...
                "binding": {
                    ...
                    "list": [{
                        ...
                        "image": {
                            "value": "https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=Mnw1NTEzfDB8MXxzZWFyY2h8N3x8SGVhbHRofGVufDF8fHx8MTY3OTc5OTY2OQ&ixlib=rb-4.0.3&q=80&w=1080",
                            "altText": "doctor holding red stethoscope",
                            "imageColor": "#c0c0c0",
                            "originalSize": {
                                "width": 3072,
                                "height": 1728
                            },
                            "authorUsername": "impulsq",
                            "authorName": "Online Marketing"
                        }
                    }, {
                        "title": "Image",
                        "subtitle": "Subtitle",
                        "description": "Describe the picture or give more information. ​​​​​​​",
                        "image": {
                            "value": "https://images.unsplash.com/photo-1674574124345-02c525664b65?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=Mnw1NTEzfDF8MXxzZWFyY2h8OHx8SGVhbHRofGVufDF8fHx8MTY3OTc5OTY2OQ&ixlib=rb-4.0.3&q=80&w=1080",
                            "altText": "a large group of people with pink flags",
                            "imageColor": "#d9d9f3",
                            "originalSize": {
                                "width": 6000,
                                "height": 4000
                            },
                            "authorUsername": "susangkomen3day",
                            "authorName": "Susan G. Komen 3-Day"
                        }
                    }, {
                        "title": "Image",
                        "subtitle": "Subtitle",
                        "description": "Describe the picture or give more information. ​​​​​​​",
                        "image": {
                            "value": "https://images.unsplash.com/photo-1505751172876-fa1923c5c528?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=Mnw1NTEzfDB8MXxzZWFyY2h8OXx8SGVhbHRofGVufDF8fHx8MTY3OTc5OTY2OQ&ixlib=rb-4.0.3&q=80&w=1080",
                            "altText": "black and gray stethoscope",
                            "imageColor": "#c0c0c0",
                            "originalSize": {
                                "width": 3543,
                                "height": 2362
                            },
                            "authorUsername": "hush52",
                            "authorName": "Hush Naidoo Jade Photography"
                        }
                    }, {
                        "title": "Image",
                        "subtitle": "Subtitle",
                        "description": "Describe the picture or give more information.",
                        "image": {
                            "value": "https://images.unsplash.com/photo-1498837167922-ddd27525d352?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=Mnw1NTEzfDB8MXxzZWFyY2h8MTB8fEhlYWx0aHxlbnwxfHx8fDE2Nzk3OTk2Njk&ixlib=rb-4.0.3&q=80&w=1080",
                            "altText": "macro shot of vegetable lot",
                            "imageColor": "#d9d9d9",
                            "originalSize": {
                                "width": 5512,
                                "height": 3675
                            },
                            "authorUsername": "danielcgold",
                            "authorName": "Dan Gold"
                        }
                    }, {
                        "title": "Image",
                        ...
                        "description": "Describe the picture or give more information.",
                        "image": {
                            "value": "https://images.unsplash.com/photo-1511632765486-a01980e01a18?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=Mnw1NTEzfDB8MXxzZWFyY2h8MTJ8fEhlYWx0aHxlbnwxfHx8fDE2Nzk3OTk2Njk&ixlib=rb-4.0.3&q=80&w=1080",
                            "altText": "four person hands wrap around shoulders while looking at sunset",
                            "imageColor": "#f3f3f3",
                            "originalSize": {
                                "width": 5472,
                                "height": 3648
                            },
                            "authorUsername": "wildlittlethingsphoto",
                        ...
                        "description": "Describe the picture or give more information. ​​​​​​​",
                        "image": {
                            "value": "https://images.unsplash.com/photo-1535914254981-b5012eebbd15?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=Mnw1NTEzfDB8MXxzZWFyY2h8MTN8fEhlYWx0aHxlbnwxfHx8fDE2Nzk3OTk2Njk&ixlib=rb-4.0.3&q=80&w=1080",
                            "altText": "assorted fruits and vegetables on green surface",
                            "imageColor": "#408c59",
                            "originalSize": {
                                "width": 7360,
                            ...
                            "authorUsername": "fishmac",
                            "authorName": "Vitalii Pavlyshynets"
                        }
                    }],
                    "image": {
                        "value": "https://storage.googleapis.com/production-hostgator-mexico-v1-0-6/626/1598626/T0w2qiz2/6c43620913dd49eb8c6b7d9da0ab8f63",
                        "altText": "woman walking on pathway during daytime",
                        "imageColor": "#26260c",
                        "originalSize": {
                            "width": 1080,
                            "height": 1080
                    ...
                    "description": "<font class=\"cstm-fnt\" style=\"font-size: 110.1%;\">Estamos comprometidos en mejorar la salud de las personas al contar con tratamientos especializados que brindan bienestar físico, mental, familiar y social,&nbsp;lo cual es fundamental para alcanzar los mejores resultados en la recuperación de nuestros pacientes.<br></font>",
                    ...
                    "aspectRatio": "kv-ee-square",
                    "borderWidth": 5,
                    "borderColor": {
                        "class": "kv-ee-custom-border-cl3",
                        "index": 0
                    },
                    "dropShadow": false,
                    "hover": "",
                ...
                "category": "text",
                "binding": {
                    "title": "<font class=\"cstm-cl kv-ee-custom-text-cl2\">¿Por qué somos tu mejor opción?</font>",
                    "subtitle": "Cuenta más a los visitantes acerca de lo que haces",
                    "description": "<font class=\"cstm-fnt cstm-cl kv-ee-custom-text-cl2\" style=\"font-size: 110.1%;\"><font class=\"cstm-fnt\" style=\"font-size: 100%;\">•\tDamos una atención personalizada.<br>•\tAplicamos tratamientos con equipos de vanguardia y personal capacitado.\n<br>•\tContamos con un sistema de evaluación funcional para conocer el pronóstico y la evolución de cada paciente.\n<br>•\tRealizamos tratamientos de acuerdo con las necesidades de cada persona.<br>•\tFomentamos el trabajo interdisciplinario.\n<br>•\tRealizamos nuestro trabajo con mucha dedicación y pasión para lograr mejores resultados.\n<br>•\tTenemos una excelente ubicación.&nbsp;<br>•\tTen la certeza de que recibes las sesiones adecuadas, invirtiendo solo lo que necesitas.</font><br></font>",
                    "buttons": [{
                        "href": "page:1682546215599",
                        "id": "01",
                        "linkType": "page",
                        "styles": {
                            "background": "",
                    ...
                    "list": [{
                        ...
                        "description": "Puede usar este elemento para explicar a los visitantes lo que hace o informarles sobre otros temas. Por ejemplo, cuál es su pasión y por qué o qué ofrece su empresa, es decir, productos y servicios. Puedes ocultar este elemento en el menú de la derecha",
                        "button": {
                            "href": "page:gallery",
                            "linkType": "page",
                            "styles": {
                    ...
                    "image": {
                        "value": "https://images.unsplash.com/photo-1486218119243-13883505764c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=Mnw1NTEzfDB8MXxzZWFyY2h8MjV8fEhlYWx0aHxlbnwwfHx8fDE2ODI1NjQ2NDI&ixlib=rb-4.0.3&q=80&w=1080"
                    },
                    "_placeholders": {
                        "subtitle": "Cuenta más a los visitantes acerca de lo que haces",
                        "description": "Puedes usar esta sección para explicar más acerca de tu pasión o lo que tu empresa tiene para ofrecer.<br>Puedes ocultar elementos de esta sección con los conmutadores a la derecha."
                    },
                    "_toggle": {
                        "title": true,
                        "subtitle": false,
            ...
            "headerSection": {
                ...
                "binding": {
                    ...
                    "cover": true,
                    "companyName": "Rehavite",
                    "features": ["navigation"]
                }
            },
            "description": "Ofrecemos servicios de fisioterapia en Durango. Estamos comprometidos en mejorar la salud de las personas al contar con tratamientos especializados de terapia física y rehabilitación. Servicios: Fisioterapia neurológica pediátrica, fisioterapia neurológica en adultos, fisioterapia ortopédica, masoterapia, etc.",
            "documentTitle": "Inicio"
        }, {
            "id": "gallery",
            "title": "Instalaciones",
            "uriPath": "instalaciones",
            "showInNavigation": true,
            "matchUriToTitle": true,
            "mainPage": false,
            "description": "En Rehavité encontrarás un servicio de calidad para tus sesiones de fisioterapia. Agrario 115, Col. Burócrata, Durango, Durango."
        }, {
            "id": "location",
            "title": "Ubicación",
            "uriPath": "ubicacion",
            ...
            "matchUriToTitle": true,
            "mainPage": false,
            "description": "Siempre cerca de ti. Agrario 115, Col. Burócrata, Durango, Durango."
        }, {
            "id": "contact",
            "title": "Contáctanos",
            "uriPath": "contactanos",
            ...
            "matchUriToTitle": true,
            "mainPage": false,
            "description": "En Rehavité estaremos encantados en ayudarte en tu pronta recuperación. Agenda tu cita de fisioterapia hoy."
        }, {
            "id": 1682546215599,
            "title": "Sobre nosotros",
            "uriPath": "sobre-nosotros",
            "showInNavigation": true,
            "matchUriToTitle": true,
            "mainPage": false,
            "description": "Creemos en el potencial del ser humano y su capacidad de lograr metas inimaginables. Promovemos la funcionalidad y la libertad de movimiento."
        }, {
            "id": 1682547295655,
            "title": "Equipo",
            "uriPath": "equipo",
            ...
            "matchUriToTitle": true,
            "mainPage": false,
            "description": "Conoce a nuestro equipo.\nDiana Delgado Medrano\nFisioterapeuta",
            "documentTitle": "Equipo"
        }, {
            "id": 1682548387051,
            "title": "Nuestros pacientes",
            "uriPath": "nuestros-pacientes",
            "showInNavigation": true,
            "matchUriToTitle": true,
            "mainPage": false,
            "documentTitle": "Nuestros pacientes",
            "description": "¿Qué dicen nuestros pacientes de nosotros?\n\"Creemos que eres una gran terapeuta y le has ayudado mucho a mi hija\". \"Sin duda no habría estos avances sin tu cariño y dedicación\"."
        }, {
            "id": 1682567020327,
            "title": "Servicios",
            "uriPath": "servicios",
            ...
            "matchUriToTitle": true,
            "mainPage": false,
            "documentTitle": "Nuestros servicios",
            "description": "Conoce cómo te podemos ayudar. Fisioterapia neurológica pediátrica, fisioterapia neurológica en adultos, fisioterapia ortopédica, terapia a domicilio en Durango."
        }],
        "metadata": {
            "siteDescription": "",
            "siteKeywords": "",
            "socialShareImage": "https://storage.googleapis.com/production-hostgator-mexico-v1-0-6/626/1598626/T0w2qiz2/a8b58786c348426d8a2cc09c604d2e7c",
            "googleAnalyticsKey": "",
            "faviconUrl": "",
            "siteName": "Rehavite Fisioterapia Integral Para Una Vida Funcional",
            "siteDomain": "",
            "siteHeaderHtml": "",
            "siteFooterHtml": "",
            "language": "es",
            ...
            "topicId": 2526,
            "topicQuery": "Health",
            "createdOn": 1679799620526,
            "initialSectionCount": 9,
            "initialPageCount": 4,
            "injectSiteId": 51824927,
            "injectedAppInstances": [],
            "verticalId": "5d7125ff-c71d-47a3-b428-df94e8f50849",
            "layoutsVersionId": "4678"
        },
        "datasources": {},
        "apiKeys": {
        ...
        "urls": {
            "re_api": "https://app-gateway.hostgator.com/express-editor",
        ...
        "navigation": [{
            ...
            "id": 1682546226392,
            "pageId": 1682546215599,
            "order": 1,
            "parentId": 0,
            "category": ""
        }, {
            "id": 1682547308162,
            "pageId": 1682547295655,
            "order": 2,
            "parentId": 0,
            "category": ""
        }, {
            "id": 1682548388318,
            "pageId": 1682548387051,
            "order": 3,
            "parentId": 0,
            "category": ""
        }, {
            "id": 1682567022150,
            "pageId": 1682567020327,
            "order": 4,
            "parentId": 0,
            "category": ""
        }, {
        ...
        "calculatedColors": {
            ...
            "text": "rgb(33, 33, 33)",
            "title": "rgb(33, 33, 33)",
            "buttonBackground": "rgb(70, 210, 184)",
    ...
    {{-- ═══ REHAVITE LANDING FIXES + DYNAMIC CONTENT ═══ --}}
    <link rel="stylesheet" href="{{ asset('css/landing-fixes.css') }}">
    <script>
    // ── Settings from database (passed via PHP) ──────────────────────────
    var _rh = {
        heroTitle:       @json($settings['hero_title'] ?? ''),
        heroSubtitle:    @json($settings['hero_subtitle'] ?? ''),
        heroButton:      @json($settings['hero_button'] ?? ''),
        contactPhone:    @json($settings['contact_phone'] ?? ''),
        contactAddress:  @json($settings['contact_address'] ?? ''),
        mapsUrl:         @json($settings['maps_url'] ?? ''),
        whatsappUrl:     @json($settings['whatsapp_url'] ?? ''),
        schedWeekdays:   @json($settings['schedule_weekdays'] ?? ''),
        schedSaturday:   @json($settings['schedule_saturday'] ?? ''),
        schedSunday:     @json($settings['schedule_sunday'] ?? ''),
        quoteText:       @json($settings['quote_text'] ?? ''),
        heroImage:       @json($settings['hero_image_url'] ?? ''),
    };

    (function() {
        var MAX_WAIT = 10000;
        var fixes_done = false;

        var interval = setInterval(function() {
            MAX_WAIT -= 200;
            if (MAX_WAIT <= 0) { clearInterval(interval); return; }

            // ─── FIX 1: Enlarge the map iframe ──────────────────────────
            ...
            // ─── FIX 2: Remove ghost/empty anchor buttons ────────────────
            document.querySelectorAll('a.kv-ee-button, a.kv-ee-button-lg').forEach(function(a) {
                if (a.textContent.trim() === '') { a.style.display = 'none'; }
            });

            // ─── FIX 3: Normalize gallery image heights ──────────────────
            var galleryImgs = document.querySelectorAll('.kv-ee-gallery img, [class*="gallery"] img');
            galleryImgs.forEach(function(img) {
                img.style.cssText += '; width:100% !important; height:220px !important; object-fit:cover !important; object-position:center !important; border-radius:10px !important;';
            ...
            // ─── DYNAMIC CONTENT: Only runs once, after builder finishes ─
            if (!fixes_done) {
                var allH2 = document.querySelectorAll('h2.kv-ee-section-title');
                if (allH2.length > 0) {
                    fixes_done = true;

                    // Hero Title — first h2 on the page
                    if (_rh.heroTitle && allH2[0]) {
                        // Clear child font tags and set text
                        allH2[0].innerHTML = '<font class="cstm-fnt cstm-cl kv-ee-custom-text-cl2">' + _rh.heroTitle + '</font>';
                    }

                    // Hero Subtitle — look for the subtitle paragraph below first section
                    var subtitleEls = document.querySelectorAll('.kv-ee-section-description, p.kv-ee-body--md');
                    if (_rh.heroSubtitle && subtitleEls[0]) {
                        subtitleEls[0].textContent = _rh.heroSubtitle;
                    }

                    // Hero Button Text
                    if (_rh.heroButton) {
                        var heroBtn = document.querySelector('a.kv-ee-button-lg');
                        if (heroBtn) { heroBtn.textContent = _rh.heroButton; }
                    }

                    // Quote text — second h2
                    if (_rh.quoteText && allH2[1]) {
                        allH2[1].innerHTML = '<font class="cstm-fnt cstm-cl kv-ee-custom-text-cl2">' + _rh.quoteText + '</font>';
                    }

                    // Opening Hours — target li items inside .kv-ee-opening-hours
                    var hoursUl = document.querySelector('ul.kv-ee-opening-hours');
                    if (hoursUl) {
                        var liItems = hoursUl.querySelectorAll('li');
                        function parseSchedule(str) {
                            // e.g. "Lunes - Viernes: 10:00am – 08:00pm"
                            var parts = str.split(':');
                            return { day: (parts[0] || '').trim(), time: str.substring(str.indexOf(':') + 1).trim() };
                        }
                        if (liItems[0] && _rh.schedWeekdays) {
                            var p = parseSchedule(_rh.schedWeekdays);
                            var daySpan = liItems[0].querySelector('.kv-ee-day');
                            var timeSpan = liItems[0].querySelector('.kv-ee-time');
                            if (daySpan) daySpan.textContent = p.day;
                            if (timeSpan) timeSpan.textContent = p.time;
                        }
                        if (liItems[1] && _rh.schedSaturday) {
                            var p2 = parseSchedule(_rh.schedSaturday);
                            var daySpan2 = liItems[1].querySelector('.kv-ee-day');
                            var timeSpan2 = liItems[1].querySelector('.kv-ee-time');
                            if (daySpan2) daySpan2.textContent = p2.day;
                            if (timeSpan2) timeSpan2.textContent = p2.time;
                        }
                        if (liItems[2]) {
                            var p3 = parseSchedule(_rh.schedSunday || 'Domingo: Cerrado');
                            var daySpan3 = liItems[2].querySelector('.kv-ee-day');
                            var timeSpan3 = liItems[2].querySelector('.kv-ee-time, .kv-ee-hours-container');
                            if (daySpan3) daySpan3.textContent = p3.day;
                            if (timeSpan3) timeSpan3.textContent = p3.time;
                            // If Sunday is "Cerrado", plain text on li
                            if (!timeSpan3) {
                                var descSpan = liItems[2].querySelector('.kv-ee-description');
                                if (descSpan) descSpan.textContent = p3.time;
                            }
                        }
                    }
                    ...
                    if (_rh.whatsappUrl) {
                        document.querySelectorAll('a[href*="wa.me"], a[href*="whatsapp"]').forEach(function(a) {
                            a.href = _rh.whatsappUrl;
                        });
                    }

                    // Maps / "Abrir en Maps" button URL
                    if (_rh.mapsUrl) {
                        document.querySelectorAll('a[href*="maps.google"], a[href*="google.com/maps"], a[href*="goo.gl/maps"]').forEach(function(a) {
                            a.href = _rh.mapsUrl;
                        });
                    }
                    ...
                    if (_rh.heroImage) {
                        var heroSection = document.querySelector('section:first-of-type .kv-background-inner, section:first-of-type .kv-background');
                        if (heroSection) {
                            heroSection.style.backgroundImage = 'url("' + _rh.heroImage + '")';
